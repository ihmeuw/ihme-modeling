...
bundle_version <- 2012 #bundle version 
...
bundle_version <- as.numeric(unlist(vars)[1]) #bundle version
...
# Save as CSV, go into file, rename sheet to 'extraction' and save as xlsx.
