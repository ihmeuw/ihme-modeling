...
map <- fread("/share/mnch/crosswalks/all_me_bundle.csv")
...
# Run MR-BRT
outdir <- "/ihme/mnch/crosswalks/gyne/logit_crosswalks/"
...
write.xlsx(fib_network, 
                     file = paste0(save_dir, "network_prep/02_input_mrbrt_network/", bun_id, "_net_prep_byloc.xlsx"),
                     row.names = FALSE)
...
matched_merge <- read.xlsx(paste0(save_dir, "network_prep/02_input_mrbrt_network/", bun_id, "_net_prep_byloc.xlsx"))
...
write.xlsx(matched_merge, 
                     file = paste0(save_dir, "network_prep/02_input_mrbrt_network/", bun_id, "_net_prep_exc_means.xlsx"),
                     row.names = FALSE)
...
matched_merge <- read.xlsx(paste0(save_dir, "network_prep/02_input_mrbrt_network/", bun_id, "_net_prep_exc_means.xlsx"))
...
# -- read in data frame
dat_original <- read_xlsx(paste0(save_dir, "agesex_split_data/all_data/", bun_id, "_", measure, ".xlsx"))
...
write.csv(final_data,
          file = paste0(save_dir, "network_prep/04_adjusted_data/", bun_id, "_", measure, ".csv"),
          row.names = FALSE)
...
write.csv(for_modeling,
          file = paste0(save_dir, "network_prep/04_adjusted_data/", bun_id, "_", measure, "_for_modeling_less_matches.csv"),
          row.names = FALSE)
