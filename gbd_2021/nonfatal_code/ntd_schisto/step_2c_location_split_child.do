...
*** ======================= MAIN EXECUTION ======================= ***
	...
	get_draws, gbd_id_type(model_id) gbd_id(ADDRESS) source(ADDRESS) measure_id(5) location_id(`location') status(best) sex_id(1 2) gbd_round_id(`gbd_round_id') decomp_step(`decomp_step') clear
	// clean files
