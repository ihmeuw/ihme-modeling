...
source(sprintf("%s/FILEPATH/get_location_metadata.R",prefix))
source(sprintf("%s/FILEPATH/get_demographics.R",prefix))
source(sprintf("%s/FILEPATH/get_population.R",prefix))
source(sprintf("%s/FILEPATH/get_ids.R",prefix))
...
pops<-get_population(age_group_id="22", decomp_step="ADDRESS", year_id=2017, location_id = "all")
...
pops<-get_population(age_group_id="22", decomp_step="ADDRESS", year_id=2000, location_id = "all")
