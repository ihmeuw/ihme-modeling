...
*** ======================= BOILERPLATE ======================= ***
	...
	cap log using "FILEPATH/step_2_`location'.smcl", replace
...
*** ======================= MAIN EXECUTION ======================= ***
    ...
    // run glms to find ratio of total cases that are haematobium vs. mansoni
	import delimited "FILEPATH/merged_species_09192019.csv", clear
