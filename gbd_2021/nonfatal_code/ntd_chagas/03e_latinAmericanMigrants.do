...
*** GET DEMOGRAPHICS AND POPULATION ESTIMATES ***	
	...
	get_population, location_id ("all") age_group_id(`ages' 22) sex_id(`sexes' 3) year_id(`years') decomp_step(`decomp_step') clear
...
*** PULL IN CHAGAS MORTALITY ESTIMATES & SUM BY LOCATION ***  
	...
	get_outputs, topic("ADDRESS") location_id("all") year_id("all") cause_id(ADDRESS) gbd_round_id(ADDRESS) decomp_step("ADDRESS") clear version(ADDRESS)
