...
myconn <- dbConnect(RMySQL::MySQL(), host="HOST", username="USERNAME", password="PASSWORD") # Requires connection to shared DB
...
raw_data_compare <- read.csv(paste0(results_dir,"/FILEPATH",archive_name,".csv"))
...
results_compare <- read.csv(paste0(results_dir,"/FILEPATH",archive_name,".csv"))
