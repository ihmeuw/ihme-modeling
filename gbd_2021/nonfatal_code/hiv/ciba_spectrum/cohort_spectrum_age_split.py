...
demProjFilePath = "FILEPAHT" + folder + "/"
...
#Reading in predicted ART coverage 
...
# HIV-free mortality
inputSRdata = beers.openCSV('FILEPATH' + ISO + "_life_tables.csv")
...
inputChildCTXeffect = beers.openCSV(AIMfilepath + "FILEPATH/Child_treatment_effects_cotrim.csv")
...
if group[0] == '1':
    ...
    inputIncSexRatio = beers.openCSV(AIMfilepath + '/FtoM_inc_ratio_epidemic_specific.csv')
    ...
    try:
        inputSexRatioAdj = beers.openCSV(AIMfilepath + "/post_1995_sex_ratios.csv")
...
inputIncAgeDist = beers.openCSV(AIMfilepath + "GEN_IRR.csv")
# CD4 distrubtion at infection
inputInitCD4dist = beers.openCSV(AIMfilepath + "CD4count_distribution_at_infection.csv")
# Mother to Child Transmission Rates
#TF - take these out?
inputMTCtransRates= beers.openCSV(AIMfilepath + "PMTCT_transmission_rts_2016.csv")
# Child CD4 distrubtion at infection for counts of eligibility
inputChildCD4countDist = beers.openCSV(AIMfilepath + 'childCD4countDist.csv')
# Child CD4 distrubtion at infection for percent eligible
inputChildCD4percentDist = beers.openCSV(AIMfilepath + 'childCD4percentDist.csv')
...
for run_id in xrange(indiv_run_nums):
    ...
    #DJ - if stage 2, no child adjustment for 1-4s (already in the file with ratios of 1)                
    if stage == 'stage_2' and parent != 'IND':
        childIncAdjPD = pd.read_csv("/ihme/hiv/ciba_temp/no_adjustment.csv")
    ...
    if stage == 'stage_3' and parent != 'IND':
        #childIncAdjPD = pd.read_csv("/ihme/hiv/ciba_temp/" + folder + "_ratios2/"+ISO+"_inc_ratios.csv")
