...
#' @import data.table, assertable, library(mortdb, lib = "/mnt/team/mortality/pub/shared/r/"), Metrics, MASS
...
assess_fit = function(run.name,stage,loc,out_folder){
    ...
    ##Potentially this should be done in rates##?????
