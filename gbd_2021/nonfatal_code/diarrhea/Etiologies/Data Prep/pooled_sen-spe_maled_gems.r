...
ggplot(data=comb, aes(x=mean_sensitivity, y=combined_sensitivity, col=pathogen)) + geom_point(size=3) + geom_abline(intercept=0, slope=1) + theme_bw() +
  scale_x_continuous("GEMS only", limits=c(0.15,1)) + scale_y_continuous("Combined", limits=c(0.15,1)) + ggtitle("Sensitivity") + geom_text(aes(label=substr(pathogen, 1,4)), col="black") +
...
ggplot(data=comb, aes(x=mean_specificity, y=combined_specificity, col=pathogen)) + geom_point(size=3) + geom_abline(intercept=0, slope=1) + theme_bw() +
  scale_x_continuous("GEMS only", limits=c(0.7,1)) + scale_y_continuous("Combined", limits=c(0.7,1)) + ggtitle("Specificity") + geom_text(aes(label=substr(pathogen, 1,4)), col="black")
