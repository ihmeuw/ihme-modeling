######################################################################################################
######################################################################################################
## Purpose: this script retrieves GBD 2020 new data, applies GBD 2019 crosswalk coefficients, and systematically 
...
#########################################################################################
  ...
  dt_total[as_mean == 0, note_modeler := paste0(note_modeler, " | GBD 2020, outliered this location-year-sex-NID age-series because age standardized mean is 0")]
  ...
  dt_total[as_mean>((MAD*mad)+median), note_modeler := paste0(note_modeler, " | GBD 2020, outliered because log age-standardized mean for location-year-sex-NID is higher than ", MAD, " MAD above median")]
  dt_total[as_mean<(median-(MAD*mad)), is_outlier := 1]
  dt_total[as_mean<(median-(MAD*mad)), note_modeler := paste0(note_modeler, " | GBD 2020, outliered because log age-standardized mean for location-year-sex-NID is lower than ", MAD, " MAD below median")]
