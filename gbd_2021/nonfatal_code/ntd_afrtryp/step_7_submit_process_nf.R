...
for (loc in hat_locs){
  write.csv(me_ADDRESS1[location_id==loc], file=paste0(draws_dir,"/ADDRESS1/",loc,".csv"))
}
...
for (loc in hat_locs){
  write.csv(me_ADDRESS2[location_id==loc], file=paste0(draws_dir,"/ADDRESS2/",loc,".csv"))
}
...
for (loc in hat_locs){
  write.csv(me_ADDRESS3[location_id==loc], file=paste0(draws_dir,"/ADDRESS3/",loc,".csv"))
}
...
for (loc in hat_locs){
  write.csv(me_ADDRESS4[location_id==loc], file=paste0(draws_dir,"/ADDRESS4/",loc,".csv"))
}
...
for (loc in hat_locs){
  write.csv(me_ADDRESS5[location_id==loc], file=paste0(draws_dir,"/ADDRESS5/",loc,".csv"))
}