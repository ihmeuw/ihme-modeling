...
# deal with  back slashes in albuminuria cv_cols
...
if ("age_sex_lit" %in% names(bdt)){
  ...
  # calculate standard error for any age-sex split rows missing standard error
