...
# Notes: Code generates a diagnostic plot -- run interatively to view this;
#   CODE WILL CLEAR THE AGE-SPLIT BUNDLE 
...
create_age_specific_dataset<-function(input_bundle_id,acause,output_bundle_id,output_filename, upload){
  ...
  if (upload==T){
    ...
    as[,seq:=NA]
    # wipe the processed-data database
