...
#drop numerator and denominator columns from age_structure data tables
...
#remove ratio and etiology columns
...
#add response rate column, needed for upload
...
all_data[,note_sr1:='data manipulated by USERNAME']
