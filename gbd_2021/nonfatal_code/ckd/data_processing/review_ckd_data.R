...
mark_error(dt_list,c(64341:64342),182,269883,"Duplicative data. Delete after decomp 3 when tabulated
           HUNT microdata is uploaded from ubcov extraction (NID 327780)")
...
mark_error(dt_list,seqs=20,182,212435,"Prevalence should extracted
...
mark_error(dt_list,seqs=c(364:369),760,129274,"Missing rows for original, raw CKD envelope extraction. Re-extract raw
           envelope data then run age-sex split from lit.")
...
mark_error(dt_list,c(486,2879,4007,4096,4173,4273), 760, 269845, "Extracted CKD column from Table 1")
