...
# Set global variables based on arg settings
offset_lab <- "FILENAME"
epi_path <- "FILEPATH"
#   -----------------------------------------------------------------------
...
# drop rows where xwalk values are NA
...
# Cut off lower and upper values where they go outside the x-axis limits
...
if (mod_type=="log_diff"){
  ...
  effect_size_lab<-paste0("Effect size: ",round(overall_effect,3), " (",overall_effect_lower," to ",overall_effect_upper,")",
                          ", Inverted to compare with DisMod: ",overall_effect_exp," (",overall_effect_lower_exp," to ",overall_effect_upper_exp,")")
}else{
  effect_size_lab<-paste0("Effect size: ",round(overall_effect,3), " (",overall_effect_lower," to ",overall_effect_upper,")")
}
