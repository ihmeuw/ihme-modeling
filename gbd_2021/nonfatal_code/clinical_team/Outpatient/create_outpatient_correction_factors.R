...
create_scalars <- function(run_id) {
  ...
  for (cause in unique(df[[rank_name]])) {
    ...
    # (this used to) smooth each one of four correction factors - incidence, prevalence, injury_cf and individual
    # Now it's just outpatient
