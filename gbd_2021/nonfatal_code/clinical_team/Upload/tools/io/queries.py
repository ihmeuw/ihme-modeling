...
class Queries:
    ...
    it's own namespace, allowing tab completion to be used when searching for
    the right query. 

    Example (Using Database):
    query_folder = os.path.dirname(__file__) + "/Queries/"
    queries = Queries(_default_query_folder)
