...
if platform.system() == "Linux":
    ...
    root = "FILEPATH"
## read in utla data
utla = pd.read_csv(root + r"FILEPATH")
...
utla_name_map = pd.read_excel(root + r"FILEPATH", sheetname="England_UTLA_codes",)
...
# uk utla and reg data has populations that end at 90+
...
both.to_csv(
    r"FILEPATH", compression="gzip", index=False,
)
