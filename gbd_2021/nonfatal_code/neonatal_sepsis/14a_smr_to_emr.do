...
foreach location_id of local location_id_list {
	...
	!qsub -N smr_to_emr_`location_id' -P PROJECT -l fthread=3 -l m_mem_free=2G -l h_rt=01:00:00 -l archive -q all.q -e FILEPATH -o FILEPATH  "FILEPATH/stata_shell.sh" "FILEPATH/smr_to_emr_parallel.do" "`location_id' `in_dir' `out_dir'"
	sleep 1000
}	
