...
prev_t1 <- data.table(get_draws("modelable_entity_id", me_id_t1, "epi", measure_id=5, gbd_round_id=gbd_round,location_id=locations, age_group_id=age_group_id, decomp_step=step))
prev_t1$type<-'1'
prev_parent <- data.table(get_draws("modelable_entity_id", me_id_parent, source="epi", measure_id=5,gbd_round_id=gbd_round,location_id=locations, age_group_id=age_group_id, decomp_step=step))
prev_parent$type<-'parent'


##V.L
vl_mod<-data.table(get_draws("modelable_entity_id", me_id_vl_mod,  "epi", measure_id=5, gbd_round_id=gbd_round,location_id=locations, age_group_id=age_group_id, decomp_step=step)) #moderate
vl_sev<- data.table(get_draws("modelable_entity_id", me_id_vl_sev,  "epi", measure_id=5, gbd_round_id=gbd_round,location_id=locations, age_group_id=age_group_id, decomp_step=step)) #severe
vl_blind<- data.table(get_draws("modelable_entity_id", me_id_vl_blind, "epi",  measure_id=5, gbd_round_id=gbd_round,location_id=locations, age_group_id=age_group_id, decomp_step=step))#blind

##Amputation
prop_amp_t1<- data.table(get_draws("modelable_entity_id",me_id_amp, source="epi", measure_id=5, gbd_round_id=gbd_round,location_id=locations, age_group_id=age_group_id, decomp_step=step)) #amputation T1

##Ulcer
prop_ulcer_t1<-data.table(get_draws("modelable_entity_id",me_id_foot, source="epi", measure_id=18, gbd_round_id=gbd_round,location_id=locations, age_group_id=age_group_id, decomp_step=step)) #ulcer T1

##Neuropathy
prop_neuro_t1<- data.table(get_draws("modelable_entity_id",me_id_neuro, source="epi", measure_id=18, gbd_round_id=gbd_round,location_id=locations, age_group_id=age_group_id, decomp_step=step)) #neuro T1
...
inc_t1 <- data.frame(get_draws("modelable_entity_id", me_id_t1, "epi", measure_id=6,gbd_round=gbd_round,location_id=locations, age_group_id=age_group_id, decomp_step = step))
inc_t1$type<-'1'
inc_parent <- data.frame(get_draws("modelable_entity_id", me_id_parent,"epi", measure_id=6, gbd_round=gbd_round,location_id=locations, age_group_id=age_group_id, decomp_step = step))
