...
def remap_coding(df, data_type_id):
    ''' Updates coding_system where ICD9_detail data are present within the uid, then
        ...
        NOTE: this process should be moved to cause_disaggregation
    '''
    def update_coding_system(group):
        ''' If a certain year/sex/registry combination has at least one ICD9
            ...
            if an individual observation is actually ICD10). This is done in the
            STATA version of this code, and is maintained for compatibility with
            other scripts. Future development may phase this out.
        '''
