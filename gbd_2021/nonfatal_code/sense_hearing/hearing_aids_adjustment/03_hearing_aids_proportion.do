...
// WRITE CODE HERE
	...
	*** PURPOSE ***
		// Create the adjustment factor for hearing aids to adjust to different severities (with Norway data NHANES because from those sources we have systematic hearing aid proportion 
