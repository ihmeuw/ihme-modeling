...
plot_trans_by_age <- function(dt) { #PLS CHANGE ALL OF THESE THINGS TOMORROW
...
#save RDS
name_of_model <- paste0("logit_network_", uf_fit1_pct, "_bv", uf_bvid, "_10age_10yr")
name_of_model
...
adjust_network <- function(statement){
  ...
  #return changed dt
  #se of test betas are way too high
