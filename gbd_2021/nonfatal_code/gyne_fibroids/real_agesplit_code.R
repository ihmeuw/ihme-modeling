...
##ARGS & DIRS--------------------------------------------------------------------------------------------------
cause_name <- "uterine_fibroids"
bundle_id <- 199 #confirm
#bundle_version <- 29825 #!!CONFIRM!!
...
agesplit_data <- age_split(split_meid = split_meid, gbd_round_id = 6, year_id = 2010, age, location_pattern_id = location_pattern_id, measures = c("prevalence", "incidence"), measure_ids = c(5,6))
