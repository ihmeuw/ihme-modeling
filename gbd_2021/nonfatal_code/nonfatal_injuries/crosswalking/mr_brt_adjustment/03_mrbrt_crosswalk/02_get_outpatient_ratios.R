...
for (i in 1:length(bundles)) {
  ...
  ci_data <- ci_data[, c('location_id', 'sex', 'year_start', 'year_end', 'age_start', 'age_end', 'mean', 'standard_error', 'clinical_data_type')]
  ...
  ci_data <- ci_data[, c('location_id', 'sex', 'year_id', 'age_start', 'age_end', 'mean', 'standard_error', 'clinical_data_type')]
  ...
  # get matched data
  df_matched <- merge(inpatient, outpatient, on=c('location_id', 'sex', 'year_id', 'age_start', 'age_end'))
