...
age_groups <- c(5:20, 30:32, 34, 235, 238, 388, 389)
measure <- "5"
...
## get draws
total_draws <- get_draws(gbd_id_type="modelable_entity_id", gbd_id=get(paste0(cause,"_total")), source="epi", location_id=location, measure_id=measure, age_group_id=age_groups, gbd_round_id=7, status="best", decomp_step=step)
unadj_acute_draws <- get_draws(gbd_id_type="modelable_entity_id", gbd_id=get(paste0(cause,"_acute")), source="epi", location_id=location, measure_id=measure, age_group_id=age_groups, gbd_round_id=7, status="best", decomp_step=step)
unadj_complic_draws <- get_draws(gbd_id_type="modelable_entity_id", gbd_id=get(paste0(cause,"_complic")), source="epi", location_id=location, measure_id=measure, age_group_id=age_groups, gbd_round_id=7, status="best", decomp_step=step)
