...
## deletes folders and contents from a previous run on the same day, commented out because we don't always want to do this 
...
epi_locations <- get_location_metadata(location_set_id=35, gbd_round_id=7, decomp_step="step3") #most detailed locations in GBD 2020 step 2 is location set id 35 
