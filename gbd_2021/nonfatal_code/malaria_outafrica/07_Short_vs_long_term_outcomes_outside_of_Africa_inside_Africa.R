...
ewan_location_id<-ihme_code$loc_id[match(main.country.list,ihme_code$ihme_lc_id)]

ewan_iso3<-as.character(ihme_code$ihme_lc_id[match(main.country.list,ihme_code$ihme_lc_id)])
