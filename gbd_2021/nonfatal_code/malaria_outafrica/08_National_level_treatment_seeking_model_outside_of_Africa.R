...
main.country.list<-as.vector(read.csv('FILEPATH')[,2])

data_location_id<-ihme_code$loc_id[match(main.country.list,ihme_code$ihme_lc_id)]

data_iso3<-as.character(ihme_code$ihme_lc_id[match(main.country.list,ihme_code$ihme_lc_id)])
...
incidence_carto<-read.csv('FILEPATH/CODEM_incidence_rate.csv')[,1:5]
