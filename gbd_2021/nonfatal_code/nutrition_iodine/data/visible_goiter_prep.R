...
h <- if (os == "Linux") paste0("FILEPATH") else if (os == "Windows") "FILEPATH"

code_dir <- if (os == "Linux") paste0("FILEPATH") else if (os == "Windows") ""
...
if(run_sex_split){
  ...
  validate_input_sheet(bundle_id, output_file, error_log_path = "FILEPATH")
