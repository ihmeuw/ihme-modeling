...
cases <- get_bundle_data(bundle_id = "ADDRESS", decomp_step = decomp_step, gbd_round_id=gbd_round_id)


## (2) Manual handling of outliers
cases[location_id==169 & year_start %in% c(1996, 1997), is_outlier := 1] # Central African Republic
cases[location_id==44860 & year_start == 1992, is_outlier := 1] # Eth - Gambella
cases[location_id==35659 & year_start == 1990, is_outlier := 1] # Kenya-Turkana
cases[location_id==190 & year_start %in% c(1990, 1992), is_outlier := 1] # UGA
