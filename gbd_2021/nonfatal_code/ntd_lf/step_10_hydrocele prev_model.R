...
lf_prev<-get_model_results(gbd_team='team_name', gbd_id=ID, gbd_round_id=ADDRESS,age_group_id=ages, sex_id=c(1,2), location_id=unique_lf_locations, year_id=c(1990,1995,2000, 2005, 2010,2015, 2019, 2020,2021,2022), decomp_step="ADDRESS")
...
region_ids<-get_location_metadata(gbd_round_id=ADDRESS, location_set_id=35)
region_ids<-region_ids[region_ids$is_estimate==1,]
...
#test # 2: 0.005, .4
#test # 3: 0.005, .1, .4
#test 4: 0.005, .4 - with the restriction on 15% inputs
knots=c(.2,.4)
