# Purpose: Hydrocele all age input prep
# Notes: this file cleans sentinel site data to use in regression of LF prevalence to hydrocele
# Notes: WHO SS data is appended to hydrocele sci lit data, column names cleaned up and output into a file to be age split 

########CLEAN WHO DATA #######################
##NOTE TO data - need to source or add to bundle using WHO NID
