...
setwd(ubcov_central)
source(paste0(ubcov_central, "/db_tools.r"))
source(paste0(ubcov_central, "/cluster_tools.r"))
source(paste0(ubcov_central, "/ubcov_tools.r"))


## Me DB
me.db <- fread("FILEPATH/me_db.csv")
me_ids <- unique(me.db$modelable_entity_id)

## Paths
draws_root <- "FILEPATH"
out_root <- paste0(draws_root, "/severity_splits")
