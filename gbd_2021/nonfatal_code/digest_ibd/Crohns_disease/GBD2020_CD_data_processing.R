################################################################################################################
################################################################################################################
## This script is used for data processing for the IBD sub-models
################################################################################################################
################################################################################################################
...
measure  <- 6 #5 is prevalence 6 is incidence
id <- MEIDs
region_pattern <- T #incidence = T and prevalence = T
...
description2 <- DESCRIPTION #description needed for each crosswalk version; this is what is going to show up in Dismod
