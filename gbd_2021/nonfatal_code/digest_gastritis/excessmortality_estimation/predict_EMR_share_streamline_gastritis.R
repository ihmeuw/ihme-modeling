...
library(msm, lib.loc = "FILEPATH_LIB")
...
#EMR data decisions
model_id <- 390998   #Dismod model from which you want to pull EMR (should be step2 best or current step3 iteration if preferable)
...
crosswalk_version_id <- 3074 #this is the crosswalk version to which you want to append the EMR data (step2 best)
bundle_id <- 7001 #this is your new bundle ID for step3 EMR
bundle_version_id <-  12221 #this is the bundle version to which you want to save your new crosswalk version after appending EMR - created in previous script!
upload_datapath <- paste0("FILEPATH/2019_step3_modeled_emr_xwalk_for_upload_", date, ".xlsx") #upload path for new crosswalk version
seq_emr <- 60180 #this is the seq generated for EMR dummy row in new bundle version
