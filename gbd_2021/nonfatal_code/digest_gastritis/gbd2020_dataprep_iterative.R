...
# ## *** Objects to process Total G/D - RUN 13 MAY 2020
# bundle_id <- 7001
# bversion_id <- 22916
# cv_alts <- c("cv_marketscan_2000", "cv_marketscan_other")
# cv_ref <- c("cv_admin")
# cv_nomatch <- c("cv_serology", "cv_self_report", "cv_endoscopy")
# old_model_summary <- paste0(j, "FILEPATH/totalgd_xwmodel_2019_07_01/") #GBD2019 final crosswalk MR-BRT model outputs
# out_path <- paste0(j, "FILEPATH")
# path_xwv_no_outlier <- paste0(out_path, "/gbd2020_tgastritis_7001_22916_xwgbd2019_nooutliers.xlsx")
# description_noout <- "GBD2020 1st CI refresh, bv22916, crosswalked, no outliers marked"
# path_xwv_2mad <- paste0(out_path, "/gbd2020_tgastritis_7001_22916_xwgbd2019_2mad.xlsx")
# description_2mad <- "GBD2020 1st CI refresh, bv22916, crosswalked, 2MAD outliers"
# gbd2019_best_xwv <- 9890  # To get modeled EMR
# ## *** Close section

# ## *** Objects to process Complicated G/D - RUN 15 MAY 2020
# bundle_id <- 3200
# bversion_id <- 22937
# cv_alts <- c("cv_marketscan_2000", "cv_marketscan_other")
# cv_ref <- c("cv_admin")
# cv_nomatch <- NULL # MIGHT NOT BE RELEVANT TO ALL SEQUELAE, WILL HAVE TO EDIT MAIN SCRIPT ACCORDINGLY
# old_model_summary <- paste0(j, "FILEPATH/compgd_xwmodel_2019_07_01/") #GBD2019 final crosswalk MR-BRT model outputs
# out_path <- paste0(j, "FILEPATH")
# path_xwv_no_outlier <- paste0(out_path, "/gbd2020_compgast_3200_bv22937_xwgbd2019_nooutliers.xlsx")
# description_noout <- "GBD2020 1st CI refresh, bv22937, crosswalked, no outliers marked"
# path_xwv_2mad <- paste0(out_path, "/gbd2020_compgast_3200_bv22937_xwgbd2019_2mad.xlsx")
...
# ## *** Objects to process Acute, uncomplicated G/D - RUN 15 MAY 2020
# bundle_id <- 3201
# bversion_id <- 22940
# cv_alts <- c("cv_marketscan_2000", "cv_marketscan_other")
# cv_ref <- c("cv_admin")
# cv_nomatch <- NULL
# old_model_summary <- paste0(j, "FILEPATH/agd_xwmodel_2019_07_01/") #GBD 2019 final crosswalk MR-BRT model outputs
# out_path <- paste0(j, "FILEPATH")
# path_xwv_no_outlier <- paste0(out_path, "/gbd2020_acutegast_3201_bv22940_xwgbd2019_nooutliers.xlsx")
# description_noout <- "GBD2020 1st CI refresh, bv22940, crosswalked, no outliers marked"
# path_xwv_2mad <- paste0(out_path, "/gbd2020_acutegast_3201_bv22940_xwgbd2019_2mad.xlsx")
...
# # *** Prevent weird validation error in 3201
...
# Total g/d xwv: 20174
# Complicated g/d xwv: 20597
# Acute uncomp g/d xwv: 20609
