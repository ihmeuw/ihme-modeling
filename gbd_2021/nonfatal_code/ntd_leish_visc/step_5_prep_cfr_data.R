...
# cfr = death data / mean estimated incidence data

#load in vl death data
vl_deaths <- get_cod_data(cause_id=ADDRESS, gbd_round_id = gbd_round_id, decomp_step = decomp_step)
...
# some parents do not have estimated incidence - population weight subnationals up to merge?
no_incidence_file <- c()
