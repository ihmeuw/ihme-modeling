...
constants <- readr::read_csv(paste0(FILEPATH,"FILEPATH"))
syphilis  <- readr::read_csv(paste0(out_dir, "FILEPATH/FILEPATH"))
haq       <- readr::read_csv(paste0(out_dir, "FILEPATH", "FILEPATH"))
