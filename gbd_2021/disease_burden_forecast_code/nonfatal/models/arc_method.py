...
def arc_method(
    ...
    A reference scenario is made using the weighted median or mean of past
...
def _linear_then_constant_arc(
    ...
    Extraploates the point ARC from the last past year till the target year to reach the target
    value.
