...
stage = "met_need"
entity = "met_need"
input_version = "20230503_met_need_with_draws"
out_version   = "20230510_met_need_zero_biased_omega"
transform = "logit"
truncate = True 
truncate_quantiles = (0.15, 0.85)
reference_scenario = "mean"
gbd_round_id = 7
years = YearRange(1970,2023,2150)
pv_years = YearRange(1970, 2013, 2022)
min_omega = 0
max_omega = 3
draws = 1000
omega_step_size = 0.5
...
data = open_xr(f"FILEPATH.nc").data
...
past = open_xr(input_dir / f"FILEPATH.nc").data
past = past.clip(max = 0.999)

pv_path = FBDPath(f"FILEPATH")
pv_file = pv_path / f"FILEPATH.nc"
...
save_xr(forecast,
        future_output_dir / f"FILEPATH.nc", metric="rate",
