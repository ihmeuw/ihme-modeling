...
if (interactive()){
  run_id <- 180029
  l <- 102
  a_input <- paste0(main_dir, "input_to_holt_", run_id, "_logitspace.csv")
...
dir.create(paste0(main_dir, 'forecasted_draws/', run_id, '/', version, '_phi0.9/'), recursive=T)
...
write.csv(predicted_draws_age,paste0(main_dir, "forecasted_draws/", run_id, "/", version, "_phi0.9/", l, ".csv"))
