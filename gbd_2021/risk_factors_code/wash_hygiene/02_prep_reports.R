...
water.cw.reg[reg == "oceania", reg := "se_asia"] # Oceania has only 2 countries with 1 source each, so including it in with SE Asia since they are both in the same GBD super region
