...
## settings
gbd_cycle <- "GBD2020"
report_dir <- file.path("FILEPATH")
microdata_dir <- file.path("FILEPATH")
...
# add the unadjusted data
# TODO: what to do about the data points of 0 or 1?
...
## water treatment #####
## 08/24/20: no HH data to crosswalk, so just adding in the extractions
