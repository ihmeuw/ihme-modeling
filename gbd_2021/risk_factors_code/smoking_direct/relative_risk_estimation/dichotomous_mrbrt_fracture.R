# evidence score for dichotomous outcome, i.e., fractures
...
dt_orig <- fread("/FILEPATH/fractures_included.csv")
...
write.csv(obs_data, paste0('FILEPATH/mrbrt_output_', cov_setting, '_', trm, '.csv'), row.names=F)
