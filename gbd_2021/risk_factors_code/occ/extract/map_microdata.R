...
trust_employment <- c("FILENAME","FILENAME","FILENAME.dta")
bypass_strings <- paste0(c("FILENAME","FILENAME","FILENAME","FILENAME",
                           "FILENAME","FILENAME","FILENAME","FILENAME",
                           "FILENAME","FILENAME","FILENAME","FILENAME",
                           "FILENAME",trust_employment),collapse="|")
...
hrh_bypass <- paste0(c("FILENAME","FILENAME","FILENAME"),collapse="|")
...
occ_truncate <- paste0(c("FILENAME","FILENAME","FILENAME"),collapse="|")
...
for (filename in in.files) {
  ...
  ## SURVEY_NAME used EXTRAVAR to differentiate whether main or secondary activity was performed in
  ...
  ## SURVEY_NAME doesn't consider agriculture as part of employment, need to backfill occ_code (assigning everyone to subsistence
