...
stgpr_models <- read.xlsx(paste0("FILEPATH/stgpr_run_log_", gbd_cycle, ".xlsx")) %>% as.data.table
best_run_ids <- stgpr_models[get(paste0(decomp_step, "_best")) == 1 & me_name %like% "occ_inj_major_", .(me_name, run_id)]
