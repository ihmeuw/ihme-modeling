...
if(imputed==T){
## this brfss is collapsed and has imputed values for diagnostic criteria  (imputation done by TEAM).  Need to change whether you read in imputed or self-report version down below (around line 610)
...
plot_output<-paste0("FILEPATH/", me, "_imptd_cw_eval.pdf")
