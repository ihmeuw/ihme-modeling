...
#  For hemorhaggic stroke (labeled as cause_id 496), save twice to cause_ids 496 and 497
...
if(F){
  ...
  # can launch it as a job too 
  
  log_dir <- paste0("FILEPATH",Sys.info()['user'])
  system(paste0("qsub -N fit_mediators",
                ...
                "-s FILEPATH/mediator_age_trends.R "))
