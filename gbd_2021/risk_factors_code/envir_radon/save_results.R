...
#--------------------SCRIPT-----------------------------------------------------------------
  ...
  paf_scatter(rei_id=90,measure_id=3,file_path=paste0("FILEPATH",decomp,".pdf"),add_isos=F,decomp_step=decomp,"_",DATE)
  paf_scatter(rei_id=90,measure_id=4,file_path=paste0("FILEPATH",decomp,".pdf"),add_isos=T,decomp_step=decomp,"_",DATE)