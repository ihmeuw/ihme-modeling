...
# Purpose: Calculate probability of SHS exposure (either occupational or household) from HH composition, primary smoking prevalence, and occupational estimates
#***************************************************************************************************************************************************************
