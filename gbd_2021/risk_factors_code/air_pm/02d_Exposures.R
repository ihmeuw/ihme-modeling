...
#This is Matt Thomas's file of helper functions
...
dir.create(out.summary, recursive=T)

# Loading weights
load(file.path(home.dir,'FILEPATH',grid.version,'Weights.RData')) # this is for shared pixels

pred_dat <- read.fst(paste0(exp.dir,"FILEPATH","/all_grids_",this.year,".fst"))
...
save(UnweightedCountry, WeightedCountry, UnweightedGBDRegion, WeightedGBDRegion, 
     ...
     file = paste0(out.summary,"/Exposures_", this.year,".RData"))
