...
water.cw.reg[reg == "oceania", reg := "se_asia"] # Oceania has only 2 countries with 1 source each, so i'm including with SE Asia since they are both in the same GBD super region
