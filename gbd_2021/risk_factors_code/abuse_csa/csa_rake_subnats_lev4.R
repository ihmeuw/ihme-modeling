...
file.list <- paste0(root, "exposure/csa_new/05_holt_data/forecasted_draws/", risk, '/', run_id, '/', version, '/', c(l, as.character(unique(locs[level==4 & parent_id==l]$location_id))), '.csv')
