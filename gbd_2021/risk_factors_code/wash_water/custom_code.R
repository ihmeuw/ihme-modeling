...
prep_and_save <- function(file, limited_use) {
  ...
  ## if not, individual-level estimates and household-level estimates will be identical -  we don't want that, since there are a different number of people and households
