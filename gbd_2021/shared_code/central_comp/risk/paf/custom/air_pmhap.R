...
rr <- get_rr(339, location_id, rr_year_id, sex_id, gbd_round_id, decomp_step,
...
dt <- merge(lbwsga, rr, by = rr_merge_cols, allow.cartesian = TRUE)
...
# if there had been no air jpollution we would have seen the CF proportion of ptb. By taking 1 - the
