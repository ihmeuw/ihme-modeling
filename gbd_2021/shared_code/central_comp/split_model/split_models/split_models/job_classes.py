...
class SplitCoDSwarm():
    ...
    def __init__(self, source_id, proportion_id_decomp_step_map,
                 proportion_measure_id, sex_ids, gbd_round_id,
                 decomp_step, intermediate_dir, outdir,
                 project):
        self.source_id = source_id
        self.proportion_id_decomp_step_map: Dict[int, str] = proportion_id_decomp_step_map
    ...
    def add_interpolate_tasks(self):
        for meid in self.proportion_id_decomp_step_map:
            for sex in self.sex_ids:
                ...
                if self.decomp_step:
                    arglist.extend([
                        '--decomp_step',
                        self.proportion_id_decomp_step_map[meid]])
