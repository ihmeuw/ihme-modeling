...
This is mainly just to clean up the codeV2.py script because it's messy.

If arguments need to change, update them here (which they probably will
for this round because of the decomposition analysis.)
"""
import argparse
