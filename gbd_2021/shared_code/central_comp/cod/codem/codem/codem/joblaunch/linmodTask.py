...
def get_rscript(scriptname):
    ...
    return str(install_dir).replace("FILEPATH", "FILEPATH")


class LinMod(object):
    def __init__(self, scriptname, model_version_id, db_connection, model_dir,
                 cores, more_args=None):
        ...
        self.call = 'FILEPATH/execRscript.sh -s ' + \
