...
class Diagnostics(ModelTask):
    ...
    def save_tables(self):
        ...
        self.merged_submodels_df.to_csv(self.model_paths.diagnostics_file("covariate_long_table.csv"), index=False)
        self.submodel_summary_df.to_csv(self.model_paths.diagnostics_file("submodel_table.csv"), index=False)
        self.covariate_summary_df.to_csv(self.model_paths.diagnostics_file("email_covariate_summary.csv"), index=False)
        self.covariate_table.to_csv(self.model_paths.diagnostics_file("covariate_table.csv"), index=False)
        self.beta_draws.to_csv(self.model_paths.diagnostics_file("beta_draws.csv"), index=False)
        self.model_type_df.to_csv(self.model_paths.diagnostics_file("model_type_df.csv"), index=False)
