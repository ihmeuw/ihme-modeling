...
def write_model_output(df_true, model_version_id, sex_id, db_connection,
    ...
    df = df[["year_id", "location_id", "sex_id", "age_group_id", "mean_cf", "lower_cf", "upper_cf"]]
    ...
    if submodel_version_id:
        ...
        table = "model"
    db_connect.write_df_to_sql(df, db="cod", table=table, connection=db_connection)
