...
class Model_List:
    ...
    def single_st(self, indices, sReg, df, ko, omega_age_smooth, time_weight_method,
        ...
        st = ST.spacetime(
            indices, sReg, df, ko, omega_age_smooth, time_weight_method,
            lambda_time_smooth, lambda_time_smooth_nodata, zeta_space_smooth,
            zeta_space_smooth_nodata
        )
        ...
        mini = df.loc[indices, ["pop", "envelope"]]
    ...
    def spacetime_predictions(self, df, ko, omega_age_smooth, time_weight_method,
        ...
        for sr in super_regions:
            ...
            for chunk_num in range(num_chunks):
                ...
                self.single_st(
                    ...
                    time_weight_method, lambda_time_smooth, lambda_time_smooth_nodata,
                    zeta_space_smooth, zeta_space_smooth_nodata
                )
    ...
    def reset_residuals(self, response_list, ko, df):
        ...
        self.res_mat = self.st_smooth_mat[indices,:] - \
                       df[(ko.iloc[:,0])][response_list].values
        self.pred_mat = None
