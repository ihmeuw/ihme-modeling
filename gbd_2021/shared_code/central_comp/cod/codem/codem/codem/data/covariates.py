...
def get_single_covariate_dataframe(covariate_id, covariate_model_id, start_year,
    ...
    df = age_sex_data(df, sex, gbd_round_id=gbd_round_id)
    df = df.drop("name", 1)
...
def get_all_covariates(model_version_id, sex, start_year, decomp_step_id, gbd_round_id,
