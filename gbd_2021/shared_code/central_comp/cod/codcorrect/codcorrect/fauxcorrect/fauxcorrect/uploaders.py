...
from fauxcorrect.parameters.machinery import (
    MachineParameters, CoDCorrectParameters)
from fauxcorrect.utils import constants
from fauxcorrect.queries.queries import Diagnostics
...
class CodCorrectDiagnosticUploader(Uploader):
    ...
    def summary_directories(self) -> List[str]:
        return [
            os.path.join(self.version.parent_dir, constants.FilePaths.DIAGNOSTICS_DIR)
        ]
