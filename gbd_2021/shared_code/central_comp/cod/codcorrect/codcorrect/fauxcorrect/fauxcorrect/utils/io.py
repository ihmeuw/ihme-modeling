...
def read_unaggregated_unscaled_draws(
        parent_dir: str,
        location_id: int,
        sex_id: int
) -> pd.DataFrame:
...
def read_unaggregated_rescaled_draws(
        parent_dir: str,
        location_id: int,
        sex_id: int
) -> pd.DataFrame:
...
def read_unaggregated_shocks_draws(
        parent_dir: str,
        location_id: int,
        sex_id: int
) -> pd.DataFrame:
...
def read_aggregated_rescaled_draws_for_summaries(
        parent_dir: str,
        location_id: int,
        year_id: int,
        measure_id: int
