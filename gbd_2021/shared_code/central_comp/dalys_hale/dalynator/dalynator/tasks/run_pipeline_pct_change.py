...
def compute_aggregates(df, n_draws, tool_name):
    ...
    if "burdenator" in tool_name:
        ...
        # During testing it is possible to reach this place WITHOUT a star_id
        # column because we are testing only part of the Burdenator sequence.
        # In production, star_id is either present in the original PAF file,
        # or is added in the Most Detailed phase.
        dc.add_star_id(df)
