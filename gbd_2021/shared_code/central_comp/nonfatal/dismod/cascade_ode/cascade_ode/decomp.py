...
|--------------------------------+-----------+--------+----------|
| feature                        | iterative | usa_re | release2 |
|--------------------------------+-----------+--------+----------|
| enable hybrid cv               | F         | F      | F        |
|--------------------------------+-----------+--------+----------|
| enable EMR/CSMR RE             | T         | T      | T        |
|--------------------------------+-----------+--------+----------|
| disable non-standard locations | F         | F      | F        |
|--------------------------------+-----------+--------+----------|
| fix bug preventing CSMR RE     | T         | T      | T        |
|--------------------------------+-----------+--------+----------|
| average CSMR from codcorrect   | F         | F      | F        |
|--------------------------------+-----------+--------+----------|
| Use CSMR from fauxcorrect      | T         | T      | T        |
|--------------------------------+-----------+--------+----------|
