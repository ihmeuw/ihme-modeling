...
from cascade_ode import __version__, drill, fit_stats, importer, upload
...
from cascade_ode.shared_functions import DismodSaveResults, get_location_metadata
...
def get_files_to_remove(dir_list, gbd_round_id, decomp_step):
    ...
    '''
    location_set_id = (
        35 if decomp_step != gbd_constants.decomp_step.USA_HEALTH_DISPARITIES
