...
from como.legacy.common import get_decomp_step_from_codcorrect_version_id
...
def compute_global_ratios(cause_id, year_id, gbd_round_id, n_draws, codcorrect_version):
    ...
    ylls = get_draws(
        ...
        decomp_step=get_decomp_step_from_codcorrect_version_id(codcorrect_version),
        n_draws=n_draws,
        downsample=True,
    )
