...
locs = maternal_fns.get_locations(decomp_step_id)
...
mort = get_envelope(
    ...
    age_group_id=maternal_fns.MATERNAL_AGE_GROUP_IDS, sex_id=2,
    year_id=maternal_fns.get_all_years(gbd_round_id),
    decomp_step=decomp.decomp_step_from_decomp_step_id(decomp_step_id),
    gbd_round_id=gbd_round_id)
