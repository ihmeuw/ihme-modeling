...
class MMR(object):
    def __init__(
        ...
        self.sex_id = [2]  # female only
        self.age_group_ids = list(range(7, 16))  # maternal ages
    ...
    def add_upload_cols(self, df):
        logging.info("Add upload columns")
    ...
    def pull_codcorrect_draws(self):
        logging.info("Pulling codcorrect draws...")
        codcorrect_df = get_draws(
            ...
            decomp_step=self.decomp_step,
            gbd_round_id=self.gbd_round_id)
        logging.info("Successfully pulled codcorrect draws.")
    ...
    def summarize_draws(self, mmr_draws):
        logging.info("Summarizing MMR draws")
