...
class ARC(object):
    ...
    def pull_mmr_draws(self):
        logging.info(f'pulling mmr draws from {self.in_dir}')
    ...
    def calculate_pct_change(self, mmr_draws):
        logging.info(f'calculating percent change')
        change_list = []
        ...
        return pd.concat(change_list).fillna(0)
...
if __name__ == '__main__':
    ...
    logging.info(f'calculating arc with args {vars(args)}')
