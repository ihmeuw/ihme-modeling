...
keep code severity hhseqid cause nesarc
...
save "./FILEPATH_${date}.dta", replace
save "./FILEPATH.dta", replace
	
keep code cause severity hhseqid  nesarc_dw dist_* 
order code cause  severity hhseqid nesarc_dw dist_mean dist_lci dist_uci 
