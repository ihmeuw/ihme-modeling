...
get_age_pattern <- function(locs, id, age_groups){
  age_pattern <- get_draws(gbd_id_type = "modelable_entity_id", gbd_id = id, 
                           ...
                           status = "best", sex_id = c(1,2), gbd_round_id = 7, decomp_step = "iterative",
...
get_pop_structure <- function(locs, years, age_groups){
  populations <- get_population(location_id = locs, year_id = years,decomp_step = "iterative", gbd_round_id = 7,
