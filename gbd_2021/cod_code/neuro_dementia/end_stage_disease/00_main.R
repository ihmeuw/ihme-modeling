...
### Purpose: Main Script for Calculating Code Differential
##########################################################################
...
graphs_dir <- paste0(italy_folder, "FILEPATH")
results_dir <- paste0(italy_folder, "FILEPATH")
...
write.csv(back_dt, paste0(results_dir, "differenceDemNoDem.csv"), row.names = F)
...
pdf(paste0(graphs_dir, "end_stage_props12.pdf"))
