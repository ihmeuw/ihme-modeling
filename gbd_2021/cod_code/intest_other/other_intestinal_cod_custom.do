*** SETUP ***
	...
	run "FILEPATH/build_cod_dataset_0701.ado"
...
local description "GBD 2020, dropped covariate ids 142 and 160"
...
save_results_cod, cause_id(321) description(gbd 2020) input_file_pattern({location_id}.csv) input_dir(/FILEPATH) decomp_step(step3) mark_best(True) clear
