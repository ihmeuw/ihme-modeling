...
#'
#'NOTE: GBD 2020 covs uploaded to EpiViz:
#'ANC 1+ - ME 10647
#'ANC 2+ - ME 24310
#'ANC 4+ - ME 24311
#'#GET DRAWS FROM DATABASE (schema for GBD 2019 and prior)
#####################################INTRO##################################################
...
anc_1 <- get_draws(gbd_id_type = "modelable_entity_id", gbd_id = 10647, source = "epi", measure_id = 18,
                         location_id = loc_id, year_id = years, age_group_id = 2, sex_id = 2, status = "best", gbd_round_id = 7,
                         decomp_step = "iterative")
anc_2 <- get_draws(gbd_id_type = "modelable_entity_id", gbd_id = 24310, source = "epi", measure_id = 18,
                       location_id = loc_id, year_id = years, age_group_id = 2, sex_id = 2, status = "best", gbd_round_id = 7,
                       decomp_step = "iterative")
anc_4 <- get_draws(gbd_id_type = "modelable_entity_id", gbd_id = 24311, source = "epi", measure_id = 18,
                       location_id = loc_id, year_id = years, age_group_id = 2, sex_id = 2, status = "best", gbd_round_id = 7,
                       decomp_step = "iterative")
