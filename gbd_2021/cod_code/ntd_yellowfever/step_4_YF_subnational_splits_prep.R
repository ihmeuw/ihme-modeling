...
pops<-get_population(age_group_id=2, sex_id=3, gbd_round_id=ADDRESS, decomp_step = ADDRESS,location_id=locs, year_id=years)
total_pops<-get_population(age_group_id=2, sex_id=3, gbd_round_id=ADDRESS, decomp_step = ADDRESS,location_id=c(179,214,180), year_id=years)
