...
AllPop <- get_population(age_group_id = 22, location_id = AllPlaces$location_id, year_id = AllPlaces$year_id, sex_id = 3, decomp_step = ADDRESS, gbd_round_id=ADDRESS)
...
library(foreign) 
#write.dta(AllOut,"skeleton_2019_usingR_usinglocset35.dta")
