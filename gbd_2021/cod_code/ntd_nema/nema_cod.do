* GBD 2020 CoD Estimation - Ascariasis
*do FILEPATH
/*====================================================================
                        0: Program set up
====================================================================*/
...
local covariate_ids 119 142 1099 3 33 1087 160 479
...
local get_model_results gbd_team(ADDRESS) version_id(`prev_model_id') measure_id(5) decomp_step(`meid_decomp_step') 
...
get_location_metadata, location_set_id(35) gbd_round_id(`gbd_round_id') clear
...
process_predictions `cause_id', link(log) random(yes) min_age(`min_age') description("`description'") multiplier(envelope) rootDir(`out_dir') saving_cause_ids(361)
