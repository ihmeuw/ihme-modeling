...
tsvacc <- fread("FILEPATH/time_since_vaccination_2022_07_22.csv")
...
#write.csv(pfiz, "FILEPATH/pfizinfec.csv", row.names = F)
#write.csv(pfiz, "FILEPATH/pfizsymp.csv", row.names = F)
fwrite(pfiz, file.path(output_dir,"pfizinf_omi.csv")) 
#write.csv(pfiz, "FILEPATH/pfizinfec_o.csv", row.names = F) 
#write.csv(pfiz, "FILEPATH/pfizsymp_o.csv", row.names = F) 
#write.csv(pfiz, "FILEPATH/pfizsev_o.csv", row.names = F)
...
#write.csv(pfizer_inf_40w, "FILEPATH/pfizer_inf_40w.csv", row.names = F)

#pfizer_symp_43w <- df_pred3
#write.csv(pfizer_symp_43w, "FILEPATH/pfizer_symp_43w.csv", row.names = F)

pfizer_sev_104w <- df_pred3
fwrite(pfizer_sev_104w, file.path(output_dir, "pfizer_sev_104w_omi.csv"))

#pfizer_inf_o30w <- df_pred3
#write.csv(pfizer_inf_o30w, "FILEPATH/pfizer_inf_o30w.csv", row.names = F)

#pfizer_symp_o_43 <- df_pred3
#write.csv(pfizer_symp_o_43, "FILEPATH/pfizer_symp_o_43.csv", row.names = F)

#pfizer_sev_o_34w <- df_pred3
#write.csv(pfizer_sev_o_34w, "FILEPATH/pfizer_sev_o_34w.csv", row.names = F)
...
#write.csv(mod, "FILEPATH/modinfec.csv", row.names = F) 
#write.csv(mod, "FILEPATH/modsymp.csv", row.names = F) 
fwrite(mod, file.path(output_dir, "modinf_omi.csv"))
#write.csv(mod, "FILEPATH/modinfec_o.csv", row.names = F) 
#write.csv(mod, "FILEPATH/modsymp_o.csv", row.names = F) 
#write.csv(mod, "FILEPATH/modsev_o.csv", row.names = F)
...
#write.csv(mod_inf_45w, "FILEPATH/mod_inf_45w.csv", row.names = F)

#mod_symp_43w <- df_pred3
#write.csv(mod_symp_43w, "FILEPATH/mod_symp_43w.csv", row.names = F)

mod_sev_104w <- df_pred3
fwrite(mod_sev_104w, file.path(output_dir, "mod_sev_104w_omi.csv"))

#mod_inf_o_45w <- df_pred3
#write.csv(mod_inf_o_45w, "FILEPATH/mod_inf_o_45w.csv", row.names = F)

#mod_symp_o_43 <- df_pred3
#write.csv(mod_symp_o_43, "FILEPATH/mod_symp_o_43.csv", row.names = F)
...
#write.csv(astra, "FILEPATH/astrainfec.csv", row.names = F) 
#write.csv(astra, "FILEPATH/astrasymp.csv", row.names = F) 
fwrite(astra, file.path(output_dir, "astrainf_omi.csv"))
#write.csv(astra, "FILEPATH/astrainfec_o.csv", row.names = F)
#write.csv(astra, "FILEPATH/astrasymp_o.csv", row.names = F) 
#write.csv(astra, "FILEPATH/astrasev_o.csv", row.names = F)
...
#write.csv(ast_inf_30w, "FILEPATH/ast_inf_30w.csv", row.names = F)

#ast_symp_27w <- df_pred3
#write.csv(ast_symp_27w, "FILEPATH/ast_symp_27w.csv", row.names = F)
...
#write.csv(ast_sev_o_30, "FILEPATH/ast_sev_o_30.csv", row.names = F)
...
#write.csv(jj, "FILEPATH/jjinfec.csv", row.names = F) 
#write.csv(jj, "FILEPATH/jjymp.csv", row.names = F) 
fwrite(jj, file.path(output_dir, "jjinf_omi.csv")) 
#write.csv(jj, "FILEPATH/jjinfec_o.csv", row.names = F)
#write.csv(jj, "FILEPATH/jjymp_o.csv", row.names = F)
#write.csv(jj, "FILEPATH/jjsev_o.csv", row.names = F)
...
#jj_inf_30w <- df_pred3
#write.csv(jj_inf_30w, "FILEPATH/jj_inf_30w.csv", row.names = F)
...
# writing csv
fwrite(mRNA_vaxes, file.path(output_dir, "mRNA_vaxes_sev_omi.csv"))
...
fwrite(mRNA_vaxes_sev_104w, file.path(output_dir, "mRNA_vaxes_sev_104w_omi.csv"))
...
# writing csv
fwrite(non_mRNA_vaxes, file.path(output_dir, "non_mRNA_vaxes_sev_omi.csv"))
...
fwrite(non_mRNA_vaxes_sev_104w, file.path(output_dir, "non_mRNA_vaxes_sev_104w_omi.csv"))
