...
inf_ancest_omi_adjusted_outliered <- fread("FILEPATH/inf_ancest_omi_adjusted_outliered.csv")
past_inf_ancest_omi_adjusted_outliered <- fread("FILEPATH/past_inf_ancest_omi_adjusted_outliered.csv")
...
infection_ancest_omi_vs_adjusted_outliered <- ggplot() + 
...
geom_line(data = subset(past_inf_ancest_omi_adjusted_outliered, mid_point < 86), mapping = aes(x = mid_point, y = pinf, color = "Ancestral/Omicron Outliered"), 
          size = 1, linetype = 1) +
  geom_line(data = subset(past_inf_ancest_omi_adjusted_outliered, mid_point > 86), mapping = aes(x = mid_point, y = pinf, color = "Ancestral/Omicron Outliered"), 
            size = 1, linetype = 2) +
  # # natural immunity points
  geom_point(data = inf_ancest_omi_adjusted_outliered, mapping = aes(x = mid_point, y = efficacy_mean, color = "Ancestral/Omicron Outliered", size = insesqua),
             show.legend = FALSE) +
  ##############################################################################
...
scale_size_continuous(range = c(0.3,3.5)) +
  scale_color_manual(values=c(
    ...
    "Ancestral/Omicron Outliered" = 'blue')
  ) +
...
print(infection_ancest_omi_vs_adjusted_outliered)
