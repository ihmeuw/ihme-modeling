...
ve2 <- mutate(spaceve2, e_mean = (efficacy_mean - 0.1)/0.9)
...
df_pred3 <- mutate(df_pred3, pinf = ((plogis(pred5)*0.9) + 0.1)) # James fix
# original 
...
past_inf_ancest_omi_adjusted_outliered <- copy(df_pred3)
past_inf_ancest_omi_adjusted_outliered <- as.data.table(past_inf_ancest_omi_adjusted_outliered)

# set pinf values >1 to 1
# past_inf_ancest_omi_adjusted$pinf[past_inf_ancest_omi_adjusted$pinf > 1] <- 1

fwrite(past_inf_ancest_omi_adjusted_outliered, file.path(output_dir, "past_inf_ancest_omi_adjusted_outliered.csv"))

# saving inf dt
inf_ancest_omi_adjusted_outliered <- copy(inf)
fwrite(inf_ancest_omi_adjusted_outliered, file.path(output_dir, "inf_ancest_omi_adjusted_outliered.csv"))
