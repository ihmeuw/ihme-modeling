...
# subsetting variant
ve2 <- subset(ve2, variant_name == variant_type)
...
past_inf_omi <- copy(df_pred3)
fwrite(past_inf_omi, file.path(output_dir, "past_inf_omi.csv"))

# saving inf dt
inf_omi <- copy(inf)
fwrite(inf_omi, file.path(output_dir, "inf_omi.csv"))
