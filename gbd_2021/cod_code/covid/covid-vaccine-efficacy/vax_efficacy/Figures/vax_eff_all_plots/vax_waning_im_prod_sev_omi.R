...
# adding 0.1 to efficacy means <0.1 


# inf$e_mean[inf$e_mean < 0.1] <- (inf$e_mean[inf$e_mean < 0.1] +0.1)
...
# writing csv
fwrite(mRNA_vaxes, file.path(output_dir, "mRNA_vaxes_sev_omi_5knots_lt_true_adjusted.csv"))
...
mod1 <- MRBRT(
  ...
  cov_models = list(
    ...
    LinearCovModel(
      ...
      spline_degree = 3L,
      spline_knots_type = 'frequency', # domain
...
mRNA_vaxes_sev_104w_omi_5knots_lt_true_adjusted <- df_pred3
fwrite(mRNA_vaxes_sev_104w_omi_5knots_lt_true_adjusted, file.path(output_dir, "mRNA_vaxes_sev_104w_omi_5knots_lt_true_adjusted.csv"))
...
# writing csv
fwrite(non_mRNA_vaxes, file.path(output_dir, "non_mRNA_vaxes_sev_omi_5knots_lt_true_adjusted.csv"))
...
non_mRNA_vaxes_sev_104w_omi_5knots_lt_true_adjusted <- df_pred3
fwrite(non_mRNA_vaxes_sev_104w_omi_5knots_lt_true_adjusted, file.path(output_dir, "non_mRNA_vaxes_sev_104w_omi_5knots_lt_true_adjusted.csv"))
