...
# writing csv
fwrite(mRNA_vaxes, file.path(output_dir, "mRNA_vaxes_sev_non_omi_5knots_lt_true_adjusted.csv"))
...
mod1 <- MRBRT(
  ...
  cov_models = list(
    ...
    LinearCovModel(
      ...
      spline_knots = array(seq(0, 1, length.out = 5)),   #(seq(0, 1, by = 0.2) #seq(0, 1, length.out = 4)
      spline_degree = 3L,
...
df_pred3 <- mutate(df_pred3, ve = (plogis(pred5)*0.9) + 0.1) # James fix
...
mRNA_vaxes_sev_104w_non_omi_5knots_lt_true_adjsuted <- df_pred3
fwrite(mRNA_vaxes_sev_104w_non_omi_5knots_lt_true_adjsuted, file.path(output_dir, "mRNA_vaxes_sev_104w_non_omi_5knots_lt_true_adjsuted.csv"))
...
# writing csv
fwrite(non_mRNA_vaxes, file.path(output_dir, "non_mRNA_vaxes_sev_non_omi_5knots_lt_true_adjusted.csv"))
...
non_mRNA_vaxes_sev_104w_non_omi_5knots_lt_true_adjusted <- df_pred3
fwrite(non_mRNA_vaxes_sev_104w_non_omi_5knots_lt_true_adjusted, file.path(output_dir, "non_mRNA_vaxes_sev_104w_non_omi_5knots_lt_true_adjusted.csv"))


# writing data set to output_dir
fwrite(ve2, file.path(output_dir, "waning_vax_eff_dt_sev_non_omi_5knots_lt_true_adjusted.csv"))
fwrite(negative_e_mean, file.path(output_dir, "negative_emean_edited_vals_sev_non_omi_5knots_lt_true_adjusted.csv"))
