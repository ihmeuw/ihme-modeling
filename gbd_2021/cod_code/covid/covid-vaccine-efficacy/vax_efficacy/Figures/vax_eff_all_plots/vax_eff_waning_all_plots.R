...
infection_alpha <- ggplot() + 
  ...
  geom_line(data = subset(pfizer_inf_104w_alpha, mid_point > 39), mapping = aes(x = mid_point, y = ve, color = "Pfizer & BioNTech"), 
            size = 1.5, linetype = 2) +
  # pfizer points
  geom_point(data = pfizinf_alpha, mapping = aes(x = mid_point, y = e_mean, color = "Pfizer & BioNTech", size = in_var)) + #shape = variant,
  # moderna lines (midpoint max = 44.5)
  geom_line(data = subset(mod_inf_104w_alpha, mid_point < 45), mapping = aes(x = mid_point, y = ve, color = "Moderna"), 
            size = 1.5, linetype = 1) +
  geom_line(data = subset(mod_inf_104w_alpha, mid_point > 45), mapping = aes(x = mid_point, y = ve, color = "Moderna"), 
            size = 1.5, linetype = 2) +
  # # moderna points 
...
geom_line(data = subset(past_inf_alpha, mid_point < 34), mapping = aes(x = mid_point, y = pinf, color = "Natural Immunity"), 
  ...
  geom_point(data = inf_alpha, mapping = aes(x = mid_point, y = e_mean, color = "Natural Immunity", size = insesqua), 
             show.legend = FALSE) +
  #############################################################################
...
geom_line(data = subset(past_inf_beta, mid_point < 45), mapping = aes(x = mid_point, y = pinf, color = "Natural Immunity"), 
  ...
  # natural immunity points
  geom_point(data = inf_beta, mapping = aes(x = mid_point, y = e_mean, color = "Natural Immunity", size = insesqua), 
             show.legend = FALSE) +
  #############################################################################
...
infection_delta <- ggplot() + 
  ...
  geom_line(data = subset(pfizer_inf_104w_delta, mid_point > 39), mapping = aes(x = mid_point, y = ve, color = "Pfizer & BioNTech"), 
            size = 1.5, linetype = 2) +
  # pfizer points
  geom_point(data = pfizinf_delta, mapping = aes(x = mid_point, y = e_mean, color = "Pfizer & BioNTech", size = in_var)) + #shape = variant,
  # moderna lines (midpoint max = 44.5)
  ...
  geom_line(data = subset(mod_inf_104w_delta, mid_point > 45), mapping = aes(x = mid_point, y = ve, color = "Moderna"), 
            size = 1.5, linetype = 2) +
# moderna points
geom_point(data = modinf_delta, mapping = aes(x = mid_point, y = e_mean, color = "Moderna", size = in_var)) +
# astra lines (midpoint max = 30)
...
geom_line(data = subset(ast_inf_104w_delta, mid_point > 31), mapping = aes(x = mid_point, y = ve, color = "AstraZeneca"),
          size = 1.5, linetype = 2) +
# astra points
geom_point(data = astrainf_delta, mapping = aes(x = mid_point, y = e_mean, color = "AstraZeneca", size = in_var)) +
# jj lines (midpoint max = 30)
...
geom_line(data = subset(jj_inf_104w_delta, mid_point > 30), mapping = aes(x = mid_point, y = ve, color = "Johnson & Johnson"),
          size = 1.5, linetype = 2) +
# jj points
geom_point(data = jjinf_delta, mapping = aes(x = mid_point, y = e_mean, color = "Johnson & Johnson", size = in_var)) +
# corona sac lines (midpoint max = 14.5)
...
geom_line(data = subset(cor_sino_inf_104w_delta, mid_point > 15), mapping = aes(x = mid_point, y = ve, color = "CoronaVac/SinoVac"),
          size = 1.5, linetype = 2) +
# corona sac points
geom_point(data = cor_sino_inf_delta, mapping = aes(x = mid_point, y = e_mean, color = "CoronaVac/SinoVac", size = in_var)) +
#############################################################################
# natural immunity lines (midpoint = 86)
...
geom_line(data = subset(past_inf_omi, mid_point < 86), mapping = aes(x = mid_point, y = pinf, color = "Natural Immunity"), 
  ...
  geom_line(data = subset(past_inf_omi, mid_point > 86), mapping = aes(x = mid_point, y = pinf, color = "Natural Immunity"), 
            size = 1.5, linetype = 2) +
  # natural immunity points
  geom_point(data = inf_omi, mapping = aes(x = mid_point, y = e_mean, color = "Natural Immunity", size = insesqua), 
             show.legend = FALSE) +
  #############################################################################
...
#############################################################################
# natural immunity lines (midpoint = 86)
geom_line(data = subset(past_inf_alpha, mid_point < 45), mapping = aes(x = mid_point, y = pinf, color = "Natural Immunity"), 
          size = 1.5, linetype = 1) +
  geom_line(data = subset(past_inf_alpha, mid_point > 45), mapping = aes(x = mid_point, y = pinf, color = "Natural Immunity"), 
            size = 1.5, linetype = 2) +
  # natural immunity points
...
#############################################################################
# natural immunity lines (midpoint = 86)
geom_line(data = subset(past_inf_beta, mid_point < 86), mapping = aes(x = mid_point, y = pinf, color = "Natural Immunity"), 
          size = 1.5, linetype = 1) +
  geom_line(data = subset(past_inf_beta, mid_point > 86), mapping = aes(x = mid_point, y = pinf, color = "Natural Immunity"), 
            size = 1.5, linetype = 2) +
  # geom_line(data = past_inf_detla, mapping = aes(x = mid_point, y = pinf, color = "Natural Immunity"), size = 1) +
