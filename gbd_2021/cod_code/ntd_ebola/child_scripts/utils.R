...
make_underreport_draws <- function(scalar_file, draws_dir){
  ...
  fwrite(under_cases_draw, paste0(draws_dir, "FILEPATH/evd_underreporting_cases_draws.csv"))
  ...
  fwrite(under_deaths_draw, paste0(draws_dir, "FILEPATHFILEPATH/evd_underreporting_deaths_draws.csv"))
