...
def manage_split(df, metric_name, uid_cols, this_dataset):
    ...
    # remove wrong ages
    #split_df = core.remove_wrong_ages(split_df)
    ...
    # save and exit
    md.complete_prep_step(final_df, df, this_dataset, is_pop)
    return(None)
...
def run_split_pop(this_dataset):
    ...
    # quick fix for registry indexes of some india datasets
