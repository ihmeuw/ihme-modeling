################################################################################
## Description: General MIR functions to be used in MIR estimation process
## How To Use: source("/FILEPATH/mir_functions.r")
...
mir.replace_missing_ages <- function(expand_this) {
    ...
    # replace missing ages for each cause (NOTE: may be faster with an apply 
    #       statement)
