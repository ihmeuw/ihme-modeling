...
write.csv(final_sex_dt, paste0(mrbrt_dir, model_name, "/sex_split.csv"), row.names = FALSE)

sex_graph <- graph_sex_predictions(graph_sex_dt)
sex_graph
ggsave(filename = paste0(mrbrt_dir, model_name, "/sex_graph.pdf"), plot = sex_graph, width = 6, height = 6)
