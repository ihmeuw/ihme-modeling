...
if __name__ == '__main__':
    ...
    if not resume:
        ...
        valid_causes = [729,945,387,699,707,695,725,726,727,854,842,711,703,
                        302,332,341,408,345,843,357,337,338]


        # Save helper files
        cause_aggregation_hierarchy.to_csv("FILEPATH")
        location_data.to_csv("FILEPATH")
        ...
        config['eligible_year_ids'] = list(range(1950, 2021))
