...
## D07 Prep
d07 <- data.table(read_dta(paste0(main_dir, "data/d07_child_and_adult_completeness.dta"), encoding = "latin1"))
...
## D08 Prep
d08 <- data.table(read_dta(paste0(main_dir, "data/d08_smoothed_completeness.dta"), encoding = "latin1"))
...
write.csv(data, paste0(main_dir, "upload/ddm_data.csv"), row.names = FALSE)

# Upload ddm data file
upload_results(filepath = paste0(main_dir, "upload/ddm_data.csv"),
               model_name = "ddm",
               model_type = "data",
