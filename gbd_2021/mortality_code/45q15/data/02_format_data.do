...
import excel using "FILEPATH", firstrow clear
	...
	** gen underlying_nid = .
	...
	save `sus_nids', replace
	use `no_nids', clear
	merge 1:1 year_id location_id sex_id age_group_id method_id source_type_id viz_year adjustment using `sus_nids', assert(1 4) nogen update replace		// Update main set
