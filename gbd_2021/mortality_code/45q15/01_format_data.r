...
setnames(single, "Var1", "ihme_loc_id")
setnames(single, "Var2", "sex")
...
fwrite(data.table(raw[!(method_id %in% c(11, 5)), ]), paste0("FILEPATH"), row.names = F)
...
# Covariates and 45q15 variables can't be Inf, for covariates
