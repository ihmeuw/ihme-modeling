...
We went through a long process to evaluate a series of life tables and feed that into
    this model, but it could still be improved.
...
model_path = "FILEPATH".format(root_dir)
