...
gbd_round_id=call_mort_function("get_gbd_round",{"gbd_year": gbd_year})
pre_gbd_year= call_mort_function("get_gbd_year",{"gbd_round" : gbd_round_id-1})
best_old_version_id = call_mort_function("get_proc_version", {"model_name" : "5q0", "model_type": "estimate", "gbd_year": pre_gbd_year,"run_id":"best"})
...
# Read in config file
output_dir = "FILEPATH"
output_dir_old= "FILEPATH/{}".format(best_old_version_id)
