...
source(paste0(code_dir, "/helper_functions/choose_reference_categories.r"))
...
# Get data
dc = DataContainer$new(gbd_round_id = gbd_round_id,
...
#NaN produced if mx - fixed_effect_beta_hiv*hiv < 0
