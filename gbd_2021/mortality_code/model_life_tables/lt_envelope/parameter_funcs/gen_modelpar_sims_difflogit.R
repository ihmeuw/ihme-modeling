...
## For more information, see pages 44-46 of the GBD2016 Mortality Appendix
...
## ============================================================================
gen_modelpar_sim <- function(elt_version, mlt_version, gbd_year){
  ...
  ## Universal LTs only, also since universal is limited by HIV, this also factors that in.
  ...
  ## Here, generate a separate dataset of the "standard" life tables, to merge onto the original empirical life table datasets for the matching aspect of the model
  ...
  ## By sex, get mean of lx values by gbd region and age (do we need to get mean of lx, or is mean of qx fine?)
  ...
  ## Get draws of everything (same seed for each draw generation) and save as modelpar_sim.dta
