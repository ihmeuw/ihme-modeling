...
recalc_ax <- function(lifetable, id_vars) {
  ## Create age variable and add a qx modification indicator (only modify those where qx >= 1 and age isn't 110)
  ...
  ## For age 110, reset qx = 1 (floating point issues make it mess with assertions)
