...
#'
#' @param run_id_45q15_est numeric or character, either "best" for best run of 45q15 estimates or numeric for a specific 45q15 estimate run
#'
...
gen_hiv_scalars <- function(run_id_45q15_est = "best") {
  ##### Gather and format data for visualization #####
  ...
  ## Use variance as the general decider, but the HIV-free qx cannot go below .15 for males and .09 for females (roughly the average of Global and High Income 45q15 estimated values)
  ## This is because in subnationals such as ZAF, we were seeing scalars selected that implied HIV-free 45q15 around .03 or other implausible trends.
  suppressWarnings(
  ...
  ## if more than one chosen choose min variance scalar (GBD 2019, saw this for KEN_35618, should look into next cycle)
