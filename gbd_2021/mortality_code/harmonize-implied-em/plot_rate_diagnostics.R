...
# HOTFIX: subset out U1 age group
...
# Load population
# TODO: just pull all years pop for EM splitting so it can be inherited
# dt_pop <- fread(
#   fs::path(
#     dir_output,
#     "pop",
...
# HOTFIX: subset to only version which have been adjusted
...
# HOTFIX: aggregate up to 1-4 age group
