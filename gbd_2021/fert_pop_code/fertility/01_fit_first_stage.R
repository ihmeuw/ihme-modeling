...
## Break SGP into 2 series
data[ihme_loc_id == 'SGP' & year_id < 2012 & grepl('VR', source_name)
     & method_name == 'Dir-Unadj', loc_source := 'SGP_VR_pre2000_TB']
data[ihme_loc_id == 'SGP' & year_id > 2012 & grepl('VR', source_name)
     & method_name == 'Dir-Unadj', loc_source := 'SGP_VR_post2000_TB']

## Break UZB into 3 series
...
#subtract coefficients from standard locations model, fit a random 
...
readr::write_csv(fe_output, paste0("FILEPATH"))
...
readr::write_csv(re_output, paste0("FILEPATH"))
...
## Add TB when VR is reference in PHL subnats
...
## If no complete VR or CBH, make locatons agnostic
...
## Only adjust recent SGP VR based on recent stat report
data[ihme_loc_id == 'SGP' & ref_source == 0, ref_source_re := data[loc_source == 'SGP_156556', unique(loc_source_re)]]
...
## Don't adjust away from reference source
