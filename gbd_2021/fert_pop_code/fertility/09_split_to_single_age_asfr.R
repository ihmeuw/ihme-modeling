...
pop1year <- copy(pop)
pop5year <- fread(paste0("FILEPATH"))
...
write_csv(fert_1_data, path = paste0("FILEPATH"))
write_csv(fert_5_data, path = paste0("FILEPATH"))
write_csv(original_tfr_data, path = paste0("FILEPATH"))

write_csv(fert_1_draws, path = paste0("FILEPATH"))
write_csv(fert_5_draws, path = paste0("FILEPATH"))
