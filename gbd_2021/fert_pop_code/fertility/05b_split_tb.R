...
input_tb <- fread(paste0("FILEPATH"))[ihme_loc_id == loc]
input_pop <- fread (paste0("FILEPATH"))[ihme_loc_id == loc]
...
loop1 <- assertable::import_files(list.files(gpr_dir, , pattern=paste0("FILEPATH"), full.names=T), 
