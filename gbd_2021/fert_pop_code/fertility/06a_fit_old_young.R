...
deprior_data <- readRDS("FILEPATH")
asfr_cov <- assertable::import_files(list.files(gpr_dir, full.names = T, pattern = "FILEPATH"), FUN=fread)
...
readr::write_csv(old_young_asfr, paste0("FILEPATH"))
