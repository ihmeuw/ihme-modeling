...
readr::write_csv(census_data, file = paste0(output_dir, "/outputs/04_aggregate_subnationals.csv"))
...
readr::write_csv(subnational_aggregate_check, file = paste0(output_dir, "/diagnostics/subnational_aggregates.csv"))
