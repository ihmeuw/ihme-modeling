...
readr::write_csv(baseline_censuses, file = paste0(output_dir, "/diagnostics/backwards_ccmpp_results.csv"))
...
readr::write_csv(census_data, file = paste0(output_dir, "/outputs/09_generate_baseline.csv"))
