...
# qsub arguments
shell_file <- "FILEPATH"
image_path <- paste0("FILEPATH", r_shell_singularity_version, ".img")
...
if (any(!output_file_exists)) {
  mortcore::qsub(jobname = paste0("download_inputs_", pop_processing_vid),
               cores = 1, mem = 20, wallclock = "00:45:00", archive_node = TRUE,
               queue = queue,
...
if (any(!output_file_exists)) {
  mortcore::qsub(jobname = paste0("correct_age_heaping_", pop_processing_vid),
               ...
               proj = submission_project_name,
               shell = shell_file,
               pass_shell = list(i = "/ihme/singularity-images/rstudio/ihme_rstudio_3501.img"),
...
if (any(!output_file_exists)) {
  mortcore::qsub(jobname = paste0("generate_sandbox_diagnostics_", pop_processing_vid),
               ...
               code = paste0(code_dir, "10b_generate_sandbox_diagnostics.py"),
