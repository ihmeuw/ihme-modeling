...
# source("/ihme/code/mortality/chacalle/shared/mortcore/R/check_data_format.R") # TODO: remove in favor of mortcore
# # Check for duplicate data points
# check_multiple_data_points(census_data, id_vars = setdiff(colnames(census_data), "mean"))
#
# # Check that ages are formatted correctly
# # TODO: update to all data once raw formatting issues are fixed or not uploading raw data
# check_age_format(census_data[outlier_type_id == 1 & sex_id != 4], id_vars = setdiff(colnames(census_data), "mean"))
