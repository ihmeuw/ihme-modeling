...
# calculate age sex accuracy index
# TODO: double check the age start min and max we want to use here. I think the example here says to do something different the example on page 22 here https://www2.census.gov/software/pas/documentation/pamvi-archive.pdf?#
