...
# TODO: This should only collapse censuses marked as not outliered
...
readr::write_csv(census_data, file = paste0(output_dir, "/outputs/06_make_manual_age_group_changes.csv"))
