...
settings <- list(
  ...
  best_pes_dismod_version_id = 304259, # TODO: rerun for GBD2019 and figure out how to pull the best version associated with a GBD year
  ...
  no_baseline_locs = c("ERI", "PAK_53617"), # TODO: See if we get new data for Gilgit-Baltistan, Will also need to add LBN to this I think
