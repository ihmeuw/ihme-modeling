...
// WRITE CODE HERE
	...
	get_draws, gbd_id_field(modelable_entity_id) gbd_id(2815) location_ids(`location') year_ids(`years') sex_ids(`sexes') ///
	status(best) source(epi) age_group_ids(`age_group_ids') clear
