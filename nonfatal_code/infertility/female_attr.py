...
class AttributeFemale(draws.SquareImport):
    ...
    def subtract_primary_only(self):
        ...
        self.me_dict[prim_key] = (prim_env - turner_hf - turner_nohf - cong_uro_inf_only - cong_uro_ag -
                                  cong_uro_uti - cong_uro_imp - cong_uro_ag_uti - cong_uro_ag_imp -
                                  cong_uro_imp_uti - cong_uro_ag_imp_uti)
    ...
    def calc_residual(self):
        ...
        self.me_dict[prim_resid_key] = prim_env - sqzd_prim
        self.me_dict[sec_resid_key] = sec_env - sqzd_sec
...
def female_attribution(me_map, location_id, out_dir):
    ...
    dim = AttributeFemale.dUSERt_idx_dmnsns
    dim["location_id"] = location_id
    dim["age_group_id"] = [{AGE GROUP IDS}]
    dim["measure_id"] = [{MEASURE IDS}]
    dim["sex_id"] = [{SEX IDS}]
