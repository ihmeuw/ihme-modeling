...
## Date: March 21, 2017
## Purpose: CHILD SCRIPT TO RUN THE MENTAL ANALYSIS - SUBMITS A JOB ARRAY
##          ANALYZES ALL OF THE CHILDREN TO PREP FOR STEP 4
##########################################################################
...
save(model, file = paste0(out_dir, "FILEPATH.rda"))
...
# into something that represents the risk of ACT due to sexual violence
...
filename <- paste0(out_dir, "FILEPATH.csv")
