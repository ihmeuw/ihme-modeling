...
foreach location of local low { 
	...
	append using `csmr_low'
	save `csmr_low', replace
}
...
gen seq = ""
generate bundle_id = 420
gen bundle_name = "Rheumatic heart disease - Low income"
gen nid = 259601
gen field_citation_value = "Institute for Health Metrics and Evaluation (IHME). Post-CoDCorrect estimates of cause-specific mortality rates for low-income/endemic countries for the relevant rheumatic heart disease DisMod model."
...
gen case_definition = "CSMR for low income/endemic model"
gen note_modeler = "3075 - low income countries only"
...
export excel using "FILEPATH/cvd_rhd_420_csmr_19Jun2017.xlsx", replace sheet("extraction") firstrow(variables)

upload_epi_data, bundle_id(420) filepath("FILEPATH/cvd_rhd_420_csmr_19Jun2017.xlsx") clear
