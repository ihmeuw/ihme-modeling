// *********************************************************************************************************************************************************************
// *********************************************************************************************************************************************************************
// Purpose:		This sub-step template is for parallelized jobs submitted from main step code. Calculating survival rate from remission and excess mortality rates
...
// get draws from most recent best DisMod model for location (remission (7) and excess mortality (9)) 
	get_draws, gbd_id_field(modelable_entity_id) gbd_id(1296) age_group_ids(`ages') source(epi) measure_ids(7 9) location_ids(`location') clear
