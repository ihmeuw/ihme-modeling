...
*** PULL THE DRAWS FROM THE INCDIENCE AGE/SEX CURVE MODEL (DISMOD USED ONLY FOR AGE-SEX SPLIT) ***  
	get_draws, gbd_id_field(modelable_entity_id) gbd_id(1461) source(dismod) location_ids(`location') measure_ids(6) age_group_ids(`ages') model_version_id(`ageModel') clear
