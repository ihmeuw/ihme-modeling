...
age.splits <- ages[age_group_id >= 8, list(age_group_id, age_group_name_short)]
age.splits[, age_merge := substr(age_group_name_short, start=1, stop=1)]
...
turnover[short==0, (turnover.cols) := 0]
