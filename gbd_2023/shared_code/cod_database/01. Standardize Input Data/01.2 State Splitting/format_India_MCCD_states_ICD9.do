...
**
    ...
    ** state names to location_ids
    odbc load, exec("SELECT location_id, location_ascii_name FROM shared.location WHERE path_to_top_parent LIKE '1,163,%' AND location_level=3 AND location_name LIKE '%Urban'") dsn(ADDRESS) clear
