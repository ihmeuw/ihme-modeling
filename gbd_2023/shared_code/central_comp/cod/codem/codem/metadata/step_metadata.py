...
class StepMetadata:
    """Class for managing a CODEm step's inputs and outputs."""

    def __init__(
        self, step_id: int, pickled_outputs: List[str], pickled_inputs: List[str]
    ) -> None:
...
STEP_DICTIONARY = {
    "InputData": StepMetadata(
        step_id=STEP_IDS["InputData"], pickled_inputs={}, pickled_outputs=[]
    ),
    "GenerateKnockouts": StepMetadata(
        step_id=STEP_IDS["GenerateKnockouts"], pickled_inputs={}, pickled_outputs=[]
    ),
    "CovariateSelection": StepMetadata(
        step_id=STEP_IDS["CovariateSelection"], pickled_inputs={}, pickled_outputs=[]
    ),
    "LinearModelBuilds": StepMetadata(
        step_id=STEP_IDS["LinearModelBuilds"],
        pickled_inputs={},
        pickled_outputs=["linmod_type_list", "response_list"],
    ),
    "ReadSpacetimeModels": StepMetadata(
    ...
    "ApplySpacetimeSmoothing": StepMetadata(
    ...
    "SpacetimePV": StepMetadata(
        ...
        pickled_outputs=[
            ...
            "st_models_rmse_all",
            "st_models_trend_all",
            "st_models_mean_error_all",
            "st_models_coverage_all",
        ],
    ),
    "LinearPV": StepMetadata(
        ...
        pickled_outputs=[
            ...
            "linear_models_mean_error_all",
            "linear_models_coverage_all",
        ],
    ),
    "OptimalPSI": StepMetadata(
        step_id=STEP_IDS["OptimalPSI"],
        pickled_inputs={
            STEP_IDS["LinearPV"]: ["linear_models_pv"],
            STEP_IDS["SpacetimePV"]: ["st_models_pv"],
            STEP_IDS["LinearModelBuilds"]: ["linmod_type_list", "response_list"],
        },
        pickled_outputs=[
            "model_pv",
            "ensemble_preds",
    ...
    "LinearDraws": StepMetadata(
        step_id=STEP_IDS["LinearDraws"],
        pickled_inputs={
            STEP_IDS["OptimalPSI"]: ["linear_models_id"],
            STEP_IDS["LinearModelBuilds"]: ["response_list"],
        },
        pickled_outputs=["linear_models_draws"],
    ),
    "GPRDraws": StepMetadata(
        step_id=STEP_IDS["GPRDraws"],
        pickled_inputs={
            STEP_IDS["OptimalPSI"]: ["st_models_id"],
            STEP_IDS["LinearModelBuilds"]: ["response_list"],
        },
        pickled_outputs=["st_models_draws"],
    ),
    "EnsemblePredictions": StepMetadata(
        step_id=STEP_IDS["EnsemblePredictions"],
        pickled_inputs={
            STEP_IDS["OptimalPSI"]: ["model_pv"],
            STEP_IDS["LinearDraws"]: ["linear_models_draws"],
            STEP_IDS["GPRDraws"]: ["st_models_draws"],
        },
        pickled_outputs=["model_pv", "draw_id"],
    ),
    "WriteResults": StepMetadata(
    ...
    "Diagnostics": StepMetadata(
        ...
        pickled_inputs={
            ...
            STEP_IDS["EnsemblePredictions"]: ["model_pv", "draw_id"],
        },
        pickled_outputs=[],
    ),
    "Email": StepMetadata(
