# This file was copied from and modified to work inside of a package.
#
...
gammaOBJ <- function() {
    list(name = "gamma", initF = nullF, mv2par = function(mn, vr) {
...
mgammaOBJ <- function() {
    list(name = "mgamma", initF = function(D) {
...
invgammaOBJ <- function() {
    list(name = "invgamma", mv2par = invgamma_mv2p, initF = nullF, dF = function(x, p) {
...
normOBJ <- function() {
    list(name = "norm", initF = nullF, mv2par = norm_mv2p, dF = function(x, p) {
...
# gnorm  -----------------------------------------------------------------------
# generalized normal distribution, classA class B, TBD, the zipfR package
...
lnormOBJ <- function() {
    list(name = "lnorm", initF = nullF, mv2par = lnorm_mv2p, dF = function(x, p) {
...
glnormOBJ <- function() {
    list(name = "glnorm", initF = function(D) {
...
expOBJ <- function() {
    list(name = "exp", initF = nullF, mv2par = function(mn, vr) {
...
# weibull  ---------------------------------------------------------------------
# the weibull family of PDFs, class A class A, standard R distribution, actuar package
...
weibullOBJ <- function() {
    list(name = "weibull", initF = nullF, mv2par = weibull_mv2p, dF = function(x, p) {
    ...
    try(
        {
            F <- function(x, mn, vr) {
                x <- abs(x)
                mn1 <- NULL
                mn1 <- integrate(xinvweibull, 0, Inf,
                    shape = x[1], scale = x[2],
                    rel.tol = 0.1, abs.tol = 0.1
                )$value
                m2 <- NULL
                m2 <- integrate(x2invweibull, 0, Inf,
                    shape = x[1], scale = x[2],
                    rel.tol = 0.1, abs.tol = 0.1
                )$value
                vr1 <- m2 - mn1^2
...
invweibullOBJ <- function() {
    list(name = "invweibull", initF = nullF, mv2par = invweibull_mv2p, dF = function(x, p) {
...
llogisOBJ <- function() {
    list(name = "llogis", initF = nullF, mv2par = llogis_mv2p, dF = function(x, p) {
...
gumbelOBJ <- function() {
    list(name = "gumbel", mv2par = gumbel_mv2p, initF = function(D) {
...
mgumbelOBJ <- function() {
    list(name = "mgumbel", initF = function(D) {
...
betasrOBJ <- function() {
    list(name = "betasr", mv2par = betasr_mv2p, initF = function(D) {
