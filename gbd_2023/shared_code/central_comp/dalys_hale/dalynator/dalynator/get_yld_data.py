...
from dataframe_io.api.public import InvalidSpec
...
def get_como_folder_structure(path_up_to_version):
    '''This function takes a path up to the version and returns the full path up to
    either FILEPATH or FILEPATH depending on which exists
    '''
