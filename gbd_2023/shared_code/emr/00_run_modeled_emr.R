...
# - thank you!
#
# Note: This script must be run on an archive node is order to source the mapping
# function
###############################################################################
...
home_dir <- paste0("FILEPATH", user_name, "/temp/emr/")

# Cause name for saving csvs and for use in plot titles
cause_name <- "digest_appendicitis"
...
crosswalk_version_id <- 44562
# Bundle version for crosswalk_version_id specified above
bundle_version_id <- 45573
# Upload path for new xwalk version
upload_datapath <- paste0(j_root, "FILEPATH", cause_name, "/",
                          bundle_id, "FILEPATH/2023_modeled_emr_xwalk_",
                          date, ".xlsx")
...
# See documentation about this data type  and sources here:
# ADDRESS
# ADDRESS
