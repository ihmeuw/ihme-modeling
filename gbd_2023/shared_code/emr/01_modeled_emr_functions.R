...
###############################################################################
## Purpose: Functions for EMR regression using MR BRT, GBD 2023
## Author:
## MR-BRT code by
## code/functions/advice incorporated from - thank you!
###############################################################################
...
remove_clinical_or_location_data <- function(data, locations_to_remove = NULL){
  ...
  clinical_nids_file <- "./data/clinical_version_id_3_NIDs.xlsx"
...
map_emr_input <- function(train_data){
  ...
  # gbd_map_func <- "FILEPATH/gbd2023_map.R"
