...
# NB vet these locations against STGPR plots! 
# Dont fix locations that are in the outbreak locations, we want to keep outbreak estimates!
...
# Because of significant discrepancies between GBD2021 STGPR results and GBD2023 STGPR results,
# will use 2021 STGPR reults for earlier years.  
