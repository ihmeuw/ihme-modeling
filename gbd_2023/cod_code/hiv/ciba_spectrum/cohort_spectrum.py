...
def readPredARTCoverage(ISO):
    import csv
    # caps_path = "/share/hiv/spectrum_input/coverage_caps/gbd2020/" + ISO + ".csv"
...
inputEligiblePops = beers.openCSV(AIMfilepath + "FILEPATH/pops_eligible_regardless_cd4_UNAIDS_2016.csv")
...
if group[0] == '2' and grid == 1:
  inputEPPinc = beers.openCSV(demProjFilePath + "/iterate_incidence/"  + inc_folder + '/' + ISO + ".csv")
...
for run_id in range(indiv_run_nums):
    ...
    #TF - child incidence adjustment scalars from CIBA                   
...
if grid == '1':
  result_path = '/ihme/hiv/spectrum_draws/' + folder + '/' + out_folder + '/'
