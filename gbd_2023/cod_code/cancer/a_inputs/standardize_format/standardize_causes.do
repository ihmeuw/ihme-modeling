...
// set script location for formatting icd10_codes. global is set by FILEPATH/_common.do
local format_ICD10_codes = FILEPATH/standardize_ICD10_codes.do"
...
if r(N) {
    ...
    run "${cancer_repo}/_database/load_database_table" "cancer_cause_map"
