...
### Project: GBD Fatal Estimation
### Purpose: EMR Regression for Parkinson
###########################################################

#Note using 2017 death results
...
## CALCULATE EXCESS MORRTALITY RATE AND LOG EXCESS MORTALITY RATE
...
## SUBSTITUTE OUT TRUE EXCESS MORTALITY ATER VALUES IF TRUE VALUE IS HIGHER THAN PREDICTION
