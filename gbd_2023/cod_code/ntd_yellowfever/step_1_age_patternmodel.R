...
bundle_df <- get_bundle_data(bundle_id, release_id = release_id)
...
braz<-get_population(gbd_round_id=ADDRESS,location_id=ID, age_group_id=ages_ids,year_id=2000,decomp_step=ADDRESS,sex_id=c(1,2))
