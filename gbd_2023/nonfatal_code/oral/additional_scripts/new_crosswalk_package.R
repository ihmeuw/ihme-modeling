...
plots$funnel_plot(
  ...
  obs_method = cv,
  plot_note = paste0("Chronic Periodontal Caries Crosswalk - ", cv, ", Mean Beta: ", 
                     round(xwalk_betas$beta[xwalk_betas$cov_names == "intercept"], digits = 3), ", \nGamma: ", 
                     round(xwalk_betas$gamma[xwalk_betas$cov_names == "intercept"], digits = 3), ", Sex Beta: ", 
                     round(xwalk_betas$beta[xwalk_betas$cov_names == "sex_id"], digits = 3), ", Age Beta: ", 
                     round(xwalk_betas$beta[xwalk_betas$cov_names == "age_mid_spline_0"], digits = 3)),
  plots_dir = "FILEPATH",
...
plots$dose_response_curve(
  ...
  cwdata = df_cw,
  cwmodel = fit1,
  plot_note = paste0("Chronic Periodontal Crosswalk - ", cv, ", Mean Beta: ", 
                     round(xwalk_betas$beta[xwalk_betas$cov_names == "intercept"], digits = 3), ", \nGamma: ", 
                     round(xwalk_betas$gamma[xwalk_betas$cov_names == "intercept"], digits = 3), ", Sex Beta: ", 
                     round(xwalk_betas$beta[xwalk_betas$cov_names == "sex_id"], digits = 3), ", Age Beta: ", 
                     round(xwalk_betas$beta[xwalk_betas$cov_names == "age_mid_spline_0"], digits = 3)),
