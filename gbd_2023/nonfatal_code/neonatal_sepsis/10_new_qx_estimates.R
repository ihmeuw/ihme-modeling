...
results <- get_life_table_with_shock(gbd_round_id =7, age_group_id = 2:3, decomp_step = "iterative")
...
write.csv(results, "FILEPATH/qx_results_v2020_loc_set_9.csv", row.names = F, na = "")
save.dta13(results, "FILEPATH/qx_results_v2020_loc_set_9.dta")

compare <- fread("FILEPATH/qx_results_v2020_all_locs.csv")
