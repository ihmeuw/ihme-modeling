...
bv$mean[bv$mean<=0] <- half_lowest_non_zero_mean
...
bv$lower[bv$lower<=0] <- half_lowest_non_zero_lwr
...
result_to_merge$lower[result_to_merge$lower<=0] <- half_lowest_non_zero_lwr
