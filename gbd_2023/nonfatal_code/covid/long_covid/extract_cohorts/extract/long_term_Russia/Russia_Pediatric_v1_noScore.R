...
tabulation <- function(path1, path2, wave_number, outpath, followup_time, typeData){
  ...
  if (typeData== "Ongoing")
  {
    followup_initial <- followup_orig[,c("subjid", "flw_sex_ong", "fully_recover_ong", "flw_loss_smell_ong","flw_loss_smell_2_ong", "flw_loss_smell_dur_ong", "flw_loss_smell_dur_2_ong","flw_loss_taste_ong", "flw_loss_taste_2_ong", "flw_loss_taste_dur_ong", "flw_loss_taste_dur_2_ong","flw_fat_ong", "flw_fat_2_ong", "flw_fat_dur_ong", "flw_fat_dur_2_ong", "vas_fatigue_ong","vas_fatigue_change_ong", "flw_muscle_pain_ong", "flw_muscle_pain_2_ong", "flw_muscle_pain_dur_ong","flw_muscle_pain_dur_2_ong", "flw_joint_pain_ong", "flw_joint_pain_2_ong", "flw_joint_pain_dur_ong", "flw_joint_pain_dur_2_ong", "flw_breathless_ong", "flw_breathless_2_ong", "flw_breathless_dur_ong","flw_breathless_dur_2_ong", "flw_pain_breathing_ong", "flw_pain_breathing_2_ong","flw_pain_breathing_dur_ong", "flw_pain_breathing_dur_2_ong", "flw_pers_cough_ong","flw_pers_cough_2_ong", "flw_pers_cough_dur_ong", "flw_pers_cough_dur_2_ong", "flw_chest_pains_ong","flw_chest_pains_2_ong", "flw_chest_pains_dur_ong", "flw_chest_pains_dur_2_ong", "flw_confusion_ong","flw_confusion_2_ong", "flw_confusion_dur_ong", "flw_confusion_dur_2_ong", "flw_eq5d5l_vas_ong","flw_eq5d5l_vas_2_ong")]
  ...
  # Fatigue
  fatg <- mod12_fol[,c('subjid','flw_fat','flw_fat_2','flw_fat_dur','flw_fat_dur_2',
                       'flw_eq5d5l_vas','flw_eq5d5l_vas_2','eq5d_pair','fully_recover')]
  # fatg$na_count <- apply(fatg[,c('flw_fat','flw_fat_2','flw_fat_dur','flw_fat_dur_2','fully_recover')], 1,
  ...
  jm_pain <- mod12_fol[,c("subjid",'flw_muscle_pain','flw_muscle_pain_2','flw_muscle_pain_dur','flw_muscle_pain_dur_2',
                          ...
                          'flw_eq5d5l_vas','flw_eq5d5l_vas_2','eq5d_pair','fully_recover')]
  # jm_pain$na_count <- apply(jm_pain[,c('flw_muscle_pain','flw_muscle_pain_2','flw_muscle_pain_dur','flw_muscle_pain_dur_2',
  #                                      'flw_joint_pain','flw_joint_pain_2','flw_joint_pain_dur','flw_joint_pain_dur_2','fully_recover')], 1,
  #                           function(x) {sum(is.na(x)) + sum(x == "NR", na.rm=TRUE)})
  ...
  # Breathless
  breath <- mod12_fol[,c('subjid','flw_breathless','flw_breathless_2','flw_breathless_dur','flw_breathless_dur_2','fully_recover',
                         'flw_eq5d5l_vas','flw_eq5d5l_vas_2','eq5d_pair')]
  # breath$na_count <- apply(breath[,c('flw_breathless','flw_breathless_2','flw_breathless_dur','flw_breathless_dur_2','fully_recover')], 1,
  #                          function(x) {sum(is.na(x)) + sum(x == "NR", na.rm=TRUE)})
  ...
  cough_chest_br <- mod12_fol[,c('subjid','flw_pain_breathing','flw_pain_breathing_2','flw_pain_breathing_dur','flw_pain_breathing_dur_2',
                                 ...
                                 'fully_recover','flw_eq5d5l_vas','flw_eq5d5l_vas_2','eq5d_pair')]

  # cough_chest_br$na_count <- apply(cough_chest_br[,c('flw_pain_breathing','flw_pain_breathing_2',
  #                                                    'flw_pain_breathing_dur','flw_pain_breathing_dur_2',
  #                                                    'flw_pers_cough','flw_pers_cough_2','flw_pers_cough_dur','flw_pers_cough_dur_2',
  #                                                    'flw_chest_pains','flw_chest_pains_2','flw_chest_pains_dur','flw_chest_pains_dur_2',
  #                                                    'fully_recover')], 1, function(x) {sum(is.na(x)) + sum(x == "NR", na.rm=TRUE)})
  ...
  forg_conf <- mod12_fol[,c('subjid','flw_confusion','flw_confusion_2','flw_confusion_dur','flw_confusion_dur_2',
                            'flw_eq5d5l_vas','flw_eq5d5l_vas_2','eq5d_pair','fully_recover')]
  # forg_conf$na_count <- apply(forg_conf[,c('flw_confusion','flw_confusion_2','flw_confusion_dur','flw_confusion_dur_2','fully_recover')], 1,
  #                             function(x) {sum(is.na(x)) + sum(x == "NR", na.rm=TRUE)})
  ...
  # (ignore since 'flw_diag_anx' & 'flw_diag_depres' contain only blanks)
  if (wave_number=="wave_1"){
    anx_depres <- mod12_fol[,c('subjid','flw_diag_anx','flw_diag_depres','fully_recover')]
    anx_depres <- mutate(anx_depres, anxiety_depressed = ifelse((flw_diag_anx %in% 1 | flw_diag_depres %in% 1) &
                                                                  fully_recover <= 5,1,0))
  } else {
    anx_depres <- mod12_fol[,c('subjid','fully_recover')]
    anx_depres <- mutate(anx_depres, anxiety_depressed = ifelse(is.na(subjid),NA,0))
  }
  ...
  # ts_loss$na_count <- apply(ts_loss[,c('flw_loss_smell','flw_loss_smell_2','flw_loss_taste','flw_loss_taste_2','fully_recover',
  #                                      'flw_loss_smell_dur','flw_loss_smell_dur_2','flw_loss_taste_dur','flw_loss_taste_dur_2')], 1,
  #                           function(x) {sum(is.na(x)) + sum(x == "NR", na.rm=TRUE)})
  ...
  a3 <- mutate(a3, long_term_extended = ifelse(long_term %in% 0 & (fatigue %in% 1 | joint_mus_pain %in% 1 | breathless %in% 1 |
                                                                     ...
                                                                     # anxiety_depressed %in% 1 |
                                                                     taste_smell_loss %in% 1), 1, 0))
  ...
  df_all <- mod12_fol[,c('subjid','fully_recover','flw_eq5d5l_vas','flw_eq5d5l_vas_2',bin_vars,bin_vars_dur)]
  DT <- as.data.frame(DT)
...
outpath<-"FILEPATH"
df_grouped_symp1 <- read_excel(paste0(outpath,"wave_1_6_month_initial_grouped_symptoms_v_",vers,".xlsx"))
df_grouped_symp2 <- read_excel(paste0(outpath,"wave_1_12_month_Ongoing_grouped_symptoms_v_",vers,".xlsx"))
df_grouped_symp3 <- read_excel(paste0(outpath,"wave_2_12_month___grouped_symptoms_v_",vers,".xlsx"))

df_grouped_symp1$follow_up <- "W1_6m"
df_grouped_symp2$follow_up <- "W1_12m"
df_grouped_symp3$follow_up <- "W2_12m"

df_grouped_symp <- rbind(df_grouped_symp1,df_grouped_symp2,df_grouped_symp3)
openxlsx::write.xlsx(df_grouped_symp, paste0(outpath, "all_grouped_symptoms_v_", vers, ".xlsx"),rowNames=F)
...
df_w2_12m_sex <- read_excel(paste0(outpath, "wave_2_12_month___bySex_v_", vers, ".xlsx"))
...
bar_plot(df_w2_12m_sex,"wave_2_12_month___bySex_v_", arrange=T)
