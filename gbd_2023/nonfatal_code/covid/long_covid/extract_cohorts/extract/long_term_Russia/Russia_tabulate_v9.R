...
mod1 <- read_excel('FILEPATH/StopCovid Cohort_Database for GBD full cohort_tvos.xlsx',
...
followup <- read_excel('FILEPATH/StopCovid Cohort_Database for GBD full cohort_tvos.xlsx', 
