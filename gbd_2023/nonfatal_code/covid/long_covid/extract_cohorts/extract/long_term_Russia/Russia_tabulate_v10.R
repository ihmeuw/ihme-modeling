...
mod1 <- read_excel('FILEPATH/StopCovid Cohort_Database for GBD.xlsx',
                 sheet="Core Module 1")[,c("subjid","Age","Sex","Diagnosis (ICD)","COVID PCR")]
...
followup <- read_excel('FILEPATH/StopCovid Cohort_Database for GBD.xlsx', 
                       sheet="Follow-up module")[,c("subjid", "flw_confusion", "flw_eq5d_ad",
