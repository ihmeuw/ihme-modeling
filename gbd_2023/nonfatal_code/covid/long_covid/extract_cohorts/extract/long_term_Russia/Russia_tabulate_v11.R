...
mod1 <- 
  read_excel('FILEPATH/Part1_2 wave U07.1.xlsx')[,c("PIN","Age","Sex","Diagnosis (ICD)")]
...
followup <- read_excel('FILEPATH/Adults Follow-up 6-8 months_2 wave.xlsx')[,c("subjid", "flw_confusion", "flw_eq5d_ad",
