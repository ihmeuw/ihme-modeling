...
followup_12m <- read_excel('FILEPATH/Ongoing_ 12 months Follow_up.xlsx')[,c("subjid", "flw_confusion_0006ff","flw_eq5d_ad_e29260",
                                                                                                                                                                                                                          'flw_eq5d_ua_dd0e43','flw_breathless_now_6d83c8',
                                                                                                                                                                                                                          'flw_breathless_c67847','flw_limb_weakness_3b26c2',
                                                                                                                                                                                                                          'flw_fatigue_e07109','flw2_for_cov','flw_remember_today_3a83ec',
                                                                                                                                                                                                                          'flw_pers_cough_bb302b','flw_eq5d_pd_2_eafcd1')]

# using the 6-8 months as the pre, read in the 6-8 months
followup_6m <- read_excel('FILEPATH/6-8 months Follow-up.xlsx')[,c("subjid","for_cov",'per_fat','flw_eq5d_ua',"flw_eq5d_ad","flw_remember_pre_c19","flw_eq5d_pd","flw_eq5d_pd_2")]
...
followup_6m$flw_eq5d_pd_2 <- followup_6m$flw_eq5d_pd_orig
followup_6m$flw_eq5d_pd <- followup_6m$flw_eq5d_pd_2_orig
followup_6m$flw_eq5d_pd_orig <- NULL
followup_6m$flw_eq5d_pd_2_orig <- NULL
...
# removing
# "Allow one of the defining items (per_fat, flw_limb_weakness,
...
setnames(clusters_6m,
         c("post_acute", "res_mild", "res_moderate", "res_severe", "res_combine", "cog_mild", "cog_moderate",
...
write.csv(cocurr_sex, paste0(outpath,"wv1_12m_ongoing_bySex_v", version, ".csv"))
