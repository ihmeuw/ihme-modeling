...
#calling data from J drive bundle

#Import adult survey

#clean the age pattern. 
adult <- read_excel('FILEPATH/Buonsenso_LongCovid-GBD_formatted_v2.xlsx', 
...
#write.csv(output,"Italy_age_pattern.csv")

#Import children survey
child <- read_excel('FILEPATH/Buonsenso_LongCovid-GBD_formatted_v2.xlsx', 
                    sheet="Pediatric")[,c("patient_id","sex","covid19_test","date_of_birth")]
# child <- read_excel('FILEPATH/Buonsenso_LongCovid-GBD_formatted_v2.xlsx', 
#                     sheet="Pediatric")[,c("patient_id","sex","covid19_test","date_of_birth","general_health_rating_today",
