...
Iran_pre <- read.csv("FILEPATH")
Iran_wo_pre <- read.csv("FILEPATH")
...
Ita_ped_pre <- read.csv("FILEPATH")
Ita_ped_wo_pre <- read.csv("FIELPATH")
...
Ita_adult_pre <- read.csv("FILEPATH")
Ita_adult_wo_pre <- read.csv("FILEPATH")
