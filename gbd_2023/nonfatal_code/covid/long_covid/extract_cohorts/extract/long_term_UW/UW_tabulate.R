...
#the UW HAARVI data was curated by NAME, extract the flags directly
UW <- read_excel('HAARVI follow-up_Theo.xlsx', sheet="HAARVI follow-up raw data")[,c('Participant Study ID',"Hospitalized/Ambulatory",'Age','Fat','Resp',"Cogn","Any'")]
