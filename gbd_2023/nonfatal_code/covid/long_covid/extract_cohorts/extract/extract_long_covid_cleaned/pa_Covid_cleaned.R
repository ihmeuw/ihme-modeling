...
#taking out those with follow_up times = 12 months
...
#write all_data
write.csv(inter, paste0("FILEPATH/German_all_data_marked_v", version, ".csv"))
...
write.csv(cocurr_mu, paste0("FILEPATH/Germany_byAgeSexICU_Hospitalized_followup_", version, ".csv"))
...
write.csv(cocurr_sex, paste0("FILEPATH/Germany_bySexICU_Hospitalized_followup_", version, ".csv"))
...
write.csv(cocurr, paste0("FILEPATH/Germany_byICU_Hospitalized_followup_", version, ".csv"))
