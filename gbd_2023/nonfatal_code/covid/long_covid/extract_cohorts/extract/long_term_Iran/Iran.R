...
## Project: NF COVID
## Script: 
## Description: Compile Iranian Data
## Contributors: NAME
## Date 2/16/2021
## --------------------------------------------------------------------- ----
...
#check my results against the Iranian collaborator's results
# table(data$Fatigue_rule1)
# table(data$Fatigue_rule2)
# table(data$cognition_cluster)
# table(data$respiratory_cluster_rule1)
# table(data$respiratory_cluster_rule2)
