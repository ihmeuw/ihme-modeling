...
# the recall_type and recall_type_value of the following rows should be reviewd.
# I am excluding them from my bundle for now.
...
write.xlsx(df_filtered, file = paste0(modeling_dir, "/step-by-step_adjustments/xwalked_bundle",bundle_id,".xlsx"), sheetName = "extraction", overwrite = TRUE)
...
description <- "GBD2023- 95+ in high income and central,eastern Europe dropped"
