...
get_age_pattern <- function(locs, id, age_groups, vid){
  age_pattern <- get_draws(gbd_id_type = "modelable_entity_id", gbd_id = id, ## USING 2010 AGE PATTERN BECAUSE LIKELY HAVE MORE DATA FOR 2010
                           ...
                           version_id = vid, sex_id = c(1,2), gbd_round_id = 7, decomp_step = "iterative",
  ...
  us_population <- get_population(location_id = locs, year_id = 2010, sex_id = c(1, 2),
                                  age_group_id = age_groups, decomp_step = "step1", gbd_round_id = 7)
...
get_pop_structure <- function(locs, years, age_groups){
  populations <- get_population(location_id = locs, year_id = years,decomp_step = "step3",
                                sex_id = c(1, 2, 3), age_group_id = age_groups, gbd_round_id = 7)
...
age_split <- function(gbd_id, df, age, region_pattern, location_pattern_id, vid, gbd_round_id = 7){
