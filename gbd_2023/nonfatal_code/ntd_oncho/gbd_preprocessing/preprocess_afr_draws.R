preprocess_afr_draws <- function(data, out_dir){
  ...
  locs <- get_location_metadata(35, release_id = ADDRESS)
  ...
  old_population <- get_population(location_id = unique(data$location_id), sex_id = c(1,2), age_group_id = c(30, 31, 32, 235), year_id = c(1990,1995,2000,2005,2010,2013), release_id = ADDRESS)
  ...
  population <- get_population(location_id = unique(data$location_id), sex_id = c(1,2), age_group_id = "all", year_id = c(1990, 1995, 2000, 2005, 2010, 2013), release_id = ADDRESS)
