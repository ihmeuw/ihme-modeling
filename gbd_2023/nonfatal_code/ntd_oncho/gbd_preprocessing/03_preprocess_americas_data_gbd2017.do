...
*--------------------1.2: Location Metadata
	...
	*Get GBD location metadata
		get_location_metadata,location_set_id(35) clear
			...
			rename path_to_top_parent country_id
...
*--------------------1.4: Population
	...
	get_population, location_id("`ameronchoids'") sex_id("`gbdsexes'") age_group_id("`gbdages'") year_id("`gbdyears'") clear
		`testing' save "`tmp_dir'FILEPATH", replace
...
*Phase 2: regular entomological evaluations to make sure there is not recrudesence over period of 3 years
