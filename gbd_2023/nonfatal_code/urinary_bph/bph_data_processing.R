################################################################################################################
################################################################################################################
## Purpose: this script does 5 things, which are 1) retrieves new data, 2) applies previous crosswalk 
##          coefficients,  3) systematically mark all (old + new) data as outliers based on MAD,
...
xwalk_coef <- read.csv(paste0(FILEPATH,"FILEPATH"))
