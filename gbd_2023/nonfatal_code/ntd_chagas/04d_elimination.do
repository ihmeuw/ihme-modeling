...
\******************************************************************************/
    ...
    * PULL IN DRAWS FROM DISMOD MODELS FOR INCIDENCE AND PREVALENVCE *
      get_draws, gbd_id_type(ADDRESS) gbd_id(`ADDRESS') source(ADDRESS) release_id(`ADDRESS') location_id(`location') age_group_id(`ages') measure_id(5 6) status(ADDRESS) clear
