# team: GBD Injuries
# script: calculation proportion of people who received care
...
filepath = 'FILEPATH'
file = 'inj_trans_road_264_whs_inp_correction.csv'
...
# apply offset in order to model in logit space, the value you choose here makes a big difference!
...
df5.to_csv('FILEPATH/st_gpr_proportions_age_specific_year_agg.csv', index=False)
