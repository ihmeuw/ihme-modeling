...
get_matches <- function(n, pair_dt, year_span = 10, age_span = 5){
  ...
  matched <- matched[sex == sex2 & measure == measure2 & year_match %between% list(year_match2 - year_span/2, year_match2 + year_span/2)] ## FILTER OUT SEX, MEASURE, YEAR
...
hep_dt <- age_dts[[1]]
age_match_dt <- age_dts[[2]] ## OPTIONAL
