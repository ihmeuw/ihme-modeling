...
# Make sure that mean < 1
highest_non_1_mean <- max(result_to_merge$mean[result_to_merge$mean < 1])
new_mean <- 1- (1-highest_non_1_mean)/5
...
write.csv(sex_splitted_bv, paste0("FILEPATH"), row.names = FALSE)
