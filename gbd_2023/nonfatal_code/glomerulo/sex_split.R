...
# SET OBJECTS -------------------------------------------------------------
cause_name = "glomerulo"
dem_dir <-"FILEPATH"
functions_dir <- "FILEPATH"
cv_drop <- c("cv_outpatient"      ,    "cv_marketscan_all_2000", "cv_marketscan_inp_2000", "cv_marketscan_all_2010", "cv_marketscan_inp_2010", "cv_marketscan_all_2012", "cv_marketscan_inp_2012", "cv_marketscan" , "cv_taiwan_claims_data" , "cv_hospital" )
...
model_name <- paste0("glomerulo_sexsplit_", date)
...
write.csv(predict_sex$final, "FILEPATH", row.names = F)
