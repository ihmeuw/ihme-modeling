...
cv_drop <- c("cv_marketscan_all_2000", "cv_marketscan_inp_2000", "cv_marketscan_all_2010", "cv_marketscan_inp_2010" ,"cv_marketscan_all_2012", "cv_marketscan_inp_2012" ,"cv_marketscan"      ,    "cv_taiwan_claims_data"  ,"cv_hospital"       )
...
model_name <- paste0("acute_urolithiasis_sexsplit_", date)
