...
#calculate log ratio of sex-specific mean estimates: female alternative; male reference-----
...
#########################################################################################
##STEP 4: GBD2021 CROSSWALK WITH UPDATED MRBRT FUNCTIONS
##########################################################################################
...
get_age_pattern <- function(locs, id, age_groups){
  age_pattern <- get_draws(gbd_id_type = "modelable_entity_id", gbd_id = id,   measure_id = measure, location_id = locs, source = "epi", ##Measure ID 5= prev, 6=incidence, 18=proportion
