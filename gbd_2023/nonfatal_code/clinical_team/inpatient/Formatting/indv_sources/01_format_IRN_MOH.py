...
# per Mohsen add 689 to the year
...
# nid_dictionary = {2001: -9, 2002: -99, 2003: -999, 2004: -9999,
#                  2005: -99999, 2006: -999999, 2007: -199, 2008: -299,
#                  2009: -399, 2010: -499}
...
# data is already binned into 5 year groups
...
# drop the missing cause code rows per Mohsen
df = df[df.dx_1 != "."].copy()
...
# this isn't true we just got 1 nid for this source
# assert len(df_agg['year_start'].unique()) == len(df_agg['nid'].unique()),\
#    "number of feature levels of years and nid should match number"
# this isn't true when there's data that needs to be split for all ages
