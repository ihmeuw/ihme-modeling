...
// Modified:		USERNAME (August 10, 2015)
// Project:		GBD
// Purpose:		Prepares the HMBD database for use
...
** **************************************************************************
	...
	** **********************************************************************
	...
	// Save
		// compress
		// save "`output_folder'/EUR_HMDB_90_14_prepped.dta", replace

// Now begin formatting
	// DROP DATA THAT CONFLICTS WITH OTHER SOURCES
		drop if inlist(iso3, "AUT", "NOR", "SWE", "GBR")
		** COUNTRIES LOSING ALL DATA: AUT, DEU, ESP, FRA, HUN, IRL, ISR, ITA, NLD
		** COUNTRIES LOSING SOME DATA: BEL, CZE, DNK, SVN
