...
// Modified:        --
// Project:     GBD
// Purpose:     Format code for USA_NHAMCS_92_10 for the hospital database
...
** **************************************************************************
    ...
    // SAVE
        compress
        save "FILEPATH/formatted_NHAMCS.dta", replace
        save "FILEPATH/formatted_NHAMCS_`today'.dta", replace
