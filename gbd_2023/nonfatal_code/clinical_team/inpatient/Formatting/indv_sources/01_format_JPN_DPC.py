...
# TODO convert_age_units is insufficient, does not convert to 1-5 months and 6-12 months
df = stage_hosp_prep.convert_age_units(df, unit_dict)

# TODO func below will break, upgrade to hosp_prep.age_binning(df, clinical_age_group_set_id)
