...
pops <- get_population(age_group_id = 42,location_id = loc_id, year_id = years, sex_id = 1:3, status = "best")
...
birth_pop0 <- get_population(age_group_id = 164, location_id = loc_id, year_id = years, sex_id = c(1,2), status = "best")
...
allcause_mr <- get_outputs(topic = "cause", measure_id = 1, location_id = loc_id, year_id = years, metric_id = 3,
                         age_group_id = 2:3, sex_id = 1:2, cause_id = 294, compare_version_id = 7283)

#convert acmr to a number of deaths (acmr * early neo & late neo population, respectively )
neo_pops <- get_population(age_group_id = 2:3, location_id = loc_id, year_id = years, sex_id = c(1,2), status = "best")
...
birth_pop <- get_population(age_group_id = 164, location_id = loc_id, year_id = years, sex_id = c(1,2), status = "best")
...
final_emr <- fill_columns(dt = format_emr, nid_to_use = csmr_nid, measure_to_use = "mtexcess", note = "NOTE")
...
csmr_values <- get_outputs(topic = "cause", measure_id = 1, location_id = loc_id, year_id = est_years, metric_id = 3,
                           age_group_id = ages_0_10_gbd20, sex_id = 1:2, cause_id = 394)
...
final_csmr <- fill_columns(dt = format_csmr, nid_to_use = csmr_nid, measure_to_use = "mtspecific", note = "CSMR")
