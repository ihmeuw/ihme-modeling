...
#   INLA mesh (ADDRESS)
#   INLA ADDRESS
#   Covariate data (FILEPATH/data)
#   Response data (FILEPATH/data)
# ----------------------------------------------------------- #
...
#'                      column names. NB, combinations of values are not created for you.
...
fitmodel <- function(runname = 'india-test',
  ...
  # Use Comoros values for mayotte
  ...
  if(is.null(startingValues)){
    ...
    # collect together some slopes start values from previous runs.
    # Slope params.
