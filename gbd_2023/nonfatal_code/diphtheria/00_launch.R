...
# system(paste0("sbatch -J diphtheria_model --mem 300G -c 10 -C archive -t 12:00:00 -p all.q -A proj_cov_vpd -o /FILEPATH/", username, "/%x.o%j ",
#              "/FILEPATH.sh -s /FILEPATH/", username, "/diphtheria/00_launch.R"))
#***********************************************************************************************************************
#
#----CONFIG-------------------------------------------------------------------------------------------------------------
### clear memory
