...
draws <- fread("FILEPATH"))[,-1]


## (2) Cleaning
# drop any national level data when you have subnational level data present
# drop Ethiopia, Nigeria, Pakistan, Kenya and India national location ids
draws <- draws[! (location_id %in% c(loc_ids))]
