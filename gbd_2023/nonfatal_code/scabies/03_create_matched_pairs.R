...
# find unique locations from nonclinical data:
data_locs <- unique(df_orig$location_name[is.na(df_orig$clinical_version_id)])
...
unique(df_orig$location_name[df_orig$nid==97501])
