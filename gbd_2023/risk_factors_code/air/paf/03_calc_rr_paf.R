...
ambient.grid.in <- file.path(paste0("FILEPATH/collapse/", exp.grid.version))
...
# Read in RR data ----------------------------------------------------------------
  ...
  # Use equation to recalculate hap RR. Excess risk for the combined exposure minus the excess risk due to ambient plus 1
