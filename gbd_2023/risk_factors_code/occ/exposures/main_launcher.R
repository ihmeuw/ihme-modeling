...
#version history#
#workers
worker.version <- 22 # GBD 2020 final

#exposures
output.version <- 46 # GBD 2020 final

# injury paf versions
inj.version <- 19 # GBD 2020 final
...
location_set_version_id <- 561
year_start <- 1970
year_end <- 2022
save.years <- 1990:2022
scatter.years <- 2019
draws.required <- 1000
decomp_step <- "iterative"
emp_xw_id <- 21353 # required for save results

paf.scatter.name <- "GB20iterative"
