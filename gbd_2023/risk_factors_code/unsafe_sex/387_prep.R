...
out<-out[location_id%in%c(95), step2_location_year:="needed to switch UK to a dismod location, changed to england"]
out<-out[location_id%in%c(95), location_id:=4749]
