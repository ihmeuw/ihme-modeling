...
save_crosswalk_version(bundle_version_id = bund$bundle_version_id, data_filepath = "FILEPATH", description = "Retain 0s, cap1, no min SS for split, no Wilson SE")

#### Final step to upload to decomp exempt bundle
source("FILEPATH")
