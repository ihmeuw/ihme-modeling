...
paths <- data.frame(
  icdmapPath   = paste0(this.dir, 'FILEPATH/package_map_icd9.csv'),
  restrictPath = paste0(this.dir, 'FILEPATH/restrictions.csv'),
  rdPath       = paste0(this.dir, 'FILEPATH/', iso3, "/", description, '/FILEPATH/'),
  acPath       = paste0(this.dir, 'FILEPATH/cause_meta.csv'),
  tempPath     = paste0(this.dir, 'FILEPATH/', iso3, '/'),
  cmetaPath    = paste0(this.dir, 'FILEPATH/'),
  stringsAsFactors = F)


source(paste0(this.dir, "FILEPATH/clean_vr.R"))
source(paste0(this.dir, "FILEPATH/apply_rd.R"))
source(paste0(this.dir, "FILEPATH/temp_collapse.R"))


for (year in 1980:1988) {

  filename_in <- paste0(this.dir, "FILEPATH/", iso3, "/", iso3, "_", year, "_vr.csv")   # path/filename of raw data
  filename_out <- paste0(this.dir, "FILEPATH/", iso3, "/", iso3, "_", year, ".csv")      # path/filename to write out to
...
# SAVE FILE --------------------------------------------------------------------------------------------------------
  ...
  filename_out <- paste0(this.dir, "FILEPATH/", iso3, "/", description, "/", iso3, "_", year, ".feather")     # path/filename to write out to
