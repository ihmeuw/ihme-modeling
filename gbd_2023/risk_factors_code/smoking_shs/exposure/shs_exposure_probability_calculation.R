#***************************************************************************************************************************************************************
# SECONDHAND SMOKE - GBD 2023
# Purpose: Calculate probability of SHS exposure (either occupational or household) from HH composition data sources, primary smoking prevalence, and occupational exposure estimates
#***************************************************************************************************************************************************************
...
locations <- get_location_metadata(release_id=16, location_set_id=22)
file.path("FILEPATH") %>% source
