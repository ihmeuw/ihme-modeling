...
os.chdir('FILEPATH')
locs_w_regions = pd.read_csv('locs_w_regions.csv')
...
os.chdir('FILEPATH')
data = pd.read_csv('gpr_input_{}.csv'.format(main_std_def))
...
os.chdir('FILEPATH')
data = pd.read_csv('updated_hyperparameters.csv')
...
pd.DataFrame(all_est).to_csv('FILEPATH/gpr_{}_{}.csv'.format(cc, main_std_def))
...
pd.DataFrame(all_sim).to_csv('FILEPATH/gpr_{}_sim_{}.csv'.format(cc, main_std_def))
