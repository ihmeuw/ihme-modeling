...
##    - cov_list: A character string of covariates in the covariate_name form                                          ##
...
assemble_prior <- function(data, rmses, cov_list, data_transform, pred_ages, me,
                           ...
                           weight_col = "out_rmse", by_sex = T, location_set_id = 22, release_id) {
  ...
  subnat_locs <- get_location_metadata(location_set_id = 101, release_id = release_id)$location_id
  ...
  # Run if age group is cumulative
  ...
  sqr <- make_square(location_set_id, release_id = release_id, year_start = 1980, year_end = 2024, covariates = NA,
