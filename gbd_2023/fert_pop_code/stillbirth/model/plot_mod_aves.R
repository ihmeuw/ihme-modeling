...
param_map_filepath <- paste0("FILEPATH/params.csv")

# Retrieve array task_id and subset to location
...
sqr.s <- readRDS(paste0("FILEPATH/", sexchar, "_data.rds"))
...
pdf(file = paste0("FILEPATH/", "subplot_", sexchar, "_", loc, ".pdf"), width = 11)
