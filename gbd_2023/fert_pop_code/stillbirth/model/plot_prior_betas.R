...
x_var <- "out_rmse" # in_rmse, out_rmse or aic
plot_pairs <- T

output_dir <- "FILEPATH"

plot_output <- paste0(output_dir, "cov_selection_beta_plots_", Sys.Date(), ".pdf")
pairs_plot_output <- paste0(output_dir, "cov_selection_beta_pairs_plots_", Sys.Date(), ".pdf")

#################
## GET RESULTS ##
#################

betas <- fread(paste0(output_dir, "FILEPATH/prior_test_output.csv"))
