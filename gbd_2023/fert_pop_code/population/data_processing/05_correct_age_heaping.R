...
total_pop_censuses <- census_data[!max_age_group_width %in% c(1, 5, 10)] # these are the censuses we eventually want more detailed age groups for
...
total_pop_censuses[location_id == 69, keep_broad_age_groups := T] # want to try keeping 0-15, 15-65, 65+ age groups in SGP from 1990 onwards
...
readr::write_csv(age_sex_ratios, paste0(output_dir, "/diagnostics/age_sex_ratios_reported.csv"))
...
readr::write_csv(age_sex_index, paste0(output_dir, "/diagnostics/age_sex_index_reported.csv"))
...
readr::write_csv(age_sex_ratios_smoothed, paste0(output_dir, "/diagnostics/age_sex_ratios_smoothed.csv"))
...
readr::write_csv(age_sex_index_smoothed, paste0(output_dir, "/diagnostics/age_sex_index_smoothed.csv"))
...
readr::write_csv(census_data_unheaped, paste0(output_dir, "/outputs/05_correct_age_heaping.csv"))
