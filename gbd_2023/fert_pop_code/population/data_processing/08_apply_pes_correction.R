...
readr::write_csv(census_data, paste0(output_dir, "/outputs/08_apply_pes_correction.csv"))
readr::write_csv(corrections, paste0(output_dir, "/outputs/08_pes_correction_variance.csv"))
