...
if (comparison_round == "WPP") {
  ...
  old_pop_age_specific <- mortcore::agg_results(old_pop, id_vars = c("location_id", "year_id", "sex_id", "age_group_id"),
                                                value_vars = c("old"), agg_hierarchy = F, age_aggs = heatmap_age_groups)
