...
#   - run the script with `python 09_generate_sandbox_diagnostics.py 129 11 GBD2019 decomp step 1`
################################################################################
...
link = "URL".format(model_version_id)
input_model_dir = "FILEPATH".format(model_version_id)
output_dir = "FILEPATH".format(model_version_id)
...
location_hierarchy = location_hierarchy.loc[(location_hierarchy['is_estimate'] == 1) & (location_hierarchy['location_set_name'] == 'population')]
