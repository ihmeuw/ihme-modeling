...
# Re-include dropped under 5 SAU data points
census_data[
  location_id == 152 & (drop) & age_group_years_end <= 5 & year_id %in% c(1992, 2004, 2022),
  drop := FALSE
]
...
readr::write_csv(census_data, paste0(output_dir, "/inputs/population.csv"))
