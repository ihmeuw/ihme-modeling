def rescale_qx_conditional(t):
    ...
    # Given that they will die between 2 and 4 what is the probability they will die during this age group
    t['c_1q2'] = t['qx_2'] / t['q_3x2']
    t['c_1q3'] = (1 - t['qx_2']) * t['qx_3'] / t['q_3x2']
    t['c_1q4'] = (1 - t['qx_2']) * (1 - t['qx_3']) * t['qx_4'] / t['q_3x2']

    # Create predicted 3q2 from conditional qx values
    t['c_3q2'] = t['c_1q2'] + t['c_1q3'] + t['c_1q4']

    # Generate scaling factor
    t['qx_2'] = t['c_1q2'] * (t['q_3x2'] / t['c_3q2'])
    t['qx_3'] = t['c_1q3'] * (t['q_3x2'] / t['c_3q2']) * (1 / ((1 - t['qx_2'])))
    t['qx_4'] = t['c_1q4'] * (t['q_3x2'] / t['c_3q2']) * (1 / ((1 - t['qx_2']) * (1 - t['qx_3'])))
...
def rescale_qx_iterator(t, iterations, number_of_scalars, scalar_max, scalar_min):
    ...
    for x in range(iterations):
        diff_columns = []
        # For some reason we do 11 instead of 10
