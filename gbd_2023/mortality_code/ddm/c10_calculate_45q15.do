...
** Output a high- / low- quality VR metric
    tempfile master
    save `master'
...
** Calculate 45q15
	...
	** Enforce that unscaled HH points should have adjusted and unadjusted 45q15 be the same
	...
	drop if (regexm(ihme_loc_id,"IND") & (year >= 1995 & year <= 2020) & (pop_source != "none - mortality rates"))

	replace deaths_nid = "86967" if regexm(ihme_loc_id,"IND") & (year >= 1995 & year <= 2020) & pop_source == "none - mortality rates"
    replace max_age_gap = 5 if regexm(ihme_loc_id,"IND") & (year >= 1995 & year <= 2020) & pop_source == "none - mortality rates"
	replace min_age_gap = 1 if regexm(ihme_loc_id,"IND") & (year >= 1995 & year <= 2020) & pop_source == "none - mortality rates"
