...
# population files
gbd_pop_file = paste0("FILEPATH")
data_pop_file = paste0("FILEPATH")
...
# subset for non-VR source types
...
# 3a2
vr[, ax_3a2 := 3 + (1 / m_chb) - (3 / (1 - exp(-3 * m_chb)))]
...
# fill missing q_u5 with all variations of dis-aggregate age groups
...
# drop years from 2008-2020 and replace with recalculated 5q0 from 5q0
...
# identify which age groups have non-missing qx values by loc/year/sex/source
dt[, age_type := ""]
