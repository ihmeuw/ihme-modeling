// Purpose:    Format code ranges and ensure that most ICD10 codes are in the proper format for subtotal disaggregation
...
** Format Codes
** ******************************************************************
// Add commas and letters between distinct codes that are adjacent
...
// Add leading zeroes for single digit codes
...
// Add decimals to 3 digit codes, add letters between distinct codes that are adjacent, correct certain code ranges
    quietly foreach 1 of numlist 0/9 {
        foreach 2 of numlist 0/9 {
...
// Add letters to each end of a code range. LIMITATIONS: does not format a small number of cases that need human interpretation (for example C01.11-12)
    quietly foreach 1 of numlist 0/9 {
        foreach 2 of numlist 0/9 {
            foreach 3 of numlist 0/9 {
