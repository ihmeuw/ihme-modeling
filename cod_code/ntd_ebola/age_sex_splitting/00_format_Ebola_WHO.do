...
** YEAR (year) **
    ...
    /*  3/15/2016: Can't remember where these month breakdowns came from, but we have proportions in West Africa by total deaths per year from USERNAME, used those proportions instead.
...
** We can't calculate cc_code where for age unknown.  Redistribute these deaths according to the age pattern
	...
	** THIS IS ALL WE NEED FOR SHOCKS, FORGET THE REST
