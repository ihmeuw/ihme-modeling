...
* PREP DATA FOR MODELLING *  
  ...
  save "FILEPATH/prep0.dta", replace
  
  import excel "FILEPATH/TRAgeo_restrictions2017.xlsx", firstrow clear
  
  merge 1:m location_id using "FILEPATH/prep0.dta"
  ...
  *keep if endemic==1; later will generate a separate data table to output 1000 draws for 0 estimates
...
* CREATE DRAWS *	
  ...
  save "FILEPATH/trachomaBlindessFullDraws2017_all.dta", replace
