 ...
 use FILEPATH/trachomaBlindessFullDraws2017_all.dta, replace
...
* GET nonfatal ESTIMATES *
 use FILEPATH/trachomaBlindessFullDraws2017_all.dta, clear
...
* SAVE RESULTS * 
  ...
  save_results_epi, modelable_entity_id(1503) measure_id(18) description("Proportion of blindess due to trachoma (custom mixed effects-no restriction)") input_dir("FILEPATH/gbd2017") input_file_pattern({location_id}.csv) clear 
