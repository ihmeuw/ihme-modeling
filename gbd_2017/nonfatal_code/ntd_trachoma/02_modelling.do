...
*save  FILEPATH/trachomaModellingData.dta, replace



*use FILEPATH/trachomaModellingData.dta, clear
...
*melogit meanBlindness ageS* prAtRiskTrachoma i.super_region_id  
