...
##### This step is more of a check than anything else. It also makes tbe dataset for later #####
...
dw_backup <- copy(final_dw) # because loop takes so long, just in case want to start from scratch post-loop
