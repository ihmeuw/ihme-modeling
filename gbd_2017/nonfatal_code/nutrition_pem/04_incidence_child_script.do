...
****************************************************************************************************************************
** whz3 no edema
get_draws, gbd_id_type(modelable_entity_id) gbd_id(1607) location_id(`loc') measure_id(5) status(best) source(epi) clear
...
*****************************************************************************************************************************
** whz3 edema
get_draws, gbd_id_type(modelable_entity_id) gbd_id(1608) location_id(`loc') measure_id(5) status(best) source(epi) clear
...
******************************************************************************************************************************
** whz2 no edema
get_draws, gbd_id_type(modelable_entity_id) gbd_id(10981) location_id(`loc') measure_id(5) status(best) source(epi) clear
...
*****************************************************************************************************************************
** whz2 edema
get_draws, gbd_id_type(modelable_entity_id) gbd_id(1606) location_id(`loc') measure_id(5) status(best) source(epi) clear
