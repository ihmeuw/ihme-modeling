...
get_draws, gbd_id_type(modelable_entity_id) gbd_id(16406) location_id(`loc') measure_id(5) status(best) source(epi) clear
...
get_draws, gbd_id_type(modelable_entity_id) gbd_id(10553) location_id(`loc') measure_id(18) status(best) source(epi) clear
...
get_draws, gbd_id_type(modelable_entity_id) gbd_id(8945) location_id(`loc') measure_id(5) status(best) source(epi) clear
...
get_draws, gbd_id_type(modelable_entity_id) gbd_id(10554) location_id(`loc') measure_id(18) status(best) source(epi) clear
merge 1:1 year_id age_group_id location_id sex_id using "`meid10553'", nogenerate keep(3)
...
get_draws, gbd_id_type(modelable_entity_id) gbd_id(8946) location_id(`loc') measure_id(5) status(best) source(epi) clear
tempfile meid8946
save `meid8946'
