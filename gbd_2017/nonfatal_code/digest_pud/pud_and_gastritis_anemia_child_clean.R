...
## define target_ids, prop_ids, source_id
...
split_epi_model(source_meid=source_id, target_meids=target_ids, prop_meids=prop_ids, split_meas_ids=5, output_dir=file.path(split_file))
