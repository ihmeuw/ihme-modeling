...
get_covariate_estimates, covariate_id(47) clear
drop age_group_id
drop sex_id
...
qui	    metan adlnrr adlnrrse `if', random title("`pat' Meta analysis of adjusted rr for `st'") nograph
		...
		//gen adlnrrse_small = invnormal(.95)/invnormal(.975)*adlnrrse
		forval i = 1/1000 {
...
// 1). Need file for Strep Pneumo calculation,
// 2). Need to generate PAFs for location, sex, age, year as CSVs for save_results //
...
// Part 1 //
	...
	keep if inlist(year_id, 1990, 1995, 2000,2001,2002,2003,2004,2005,2006,2007,2008,2009,2010,2011,2012,2013,2014,2015,2016,2017)
...
cap drop v1-v1000
saveold "FILEPATH/hib_paf_draws.dta", replace
