...
tab <- read.csv("FILEPATH/df_month_2017.csv")
...
write.csv(curves, "FILEPATH/month_region_scalar_2017.csv")
write.csv(pred.df, "FILEPATH/seasonal_lri_prediction_2017.csv")
