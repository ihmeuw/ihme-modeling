...
** **************************************************************************
	...
	** ****************************************************************
		...
		** ****************************************************************
			// Data Source Name
				local data_name "USA_HCUP_SID_07"
			// Start/End year
				local year_start 2007
				local year_end 2007
...
// drop unneeded cols
	...
	// SAVE
		compress
		save "`output_folder'/formatted_USA_HCUP_SID_07.dta", replace
		save "`archive_folder'/formatted_USA_HCUP_SID_07_`today'.dta", replace
