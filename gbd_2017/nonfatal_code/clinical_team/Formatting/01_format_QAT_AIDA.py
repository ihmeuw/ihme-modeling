...
# read in each file
df02 = pd.read_excel(r"FILEPATH\QAT_INPATIENT_DISCHARGE_2002_table.xlsx", header=1)
df03 = pd.read_excel(r"FILEPATH\QAT_INPATIENT_DISCHARGE_2003_table.xlsx", header=1)

df03w = pd.read_excel(r"FILEPATH\QAT_INPATIENT_DISCHARGE_2003_table_2.xlsx", header=1)
...
# Saving the file
write_path = "FILEPATH/formatted_QAT_AIDA.H5"
