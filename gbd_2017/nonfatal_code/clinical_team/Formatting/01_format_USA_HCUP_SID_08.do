...
** **************************************************************************
	...
	** ****************************************************************
		...
		** ****************************************************************
			// Data Source Name
				local data_name "USA_HCUP_SID_08"
			// Start/End year
...
// drop unneeded cols
	...
	// SAVE
		compress
		save "`output_folder'/formatted_USA_HCUP_SID_08.dta", replace
		save "`archive_folder'/formatted_USA_HCUP_SID_08_`today'.dta", replace
