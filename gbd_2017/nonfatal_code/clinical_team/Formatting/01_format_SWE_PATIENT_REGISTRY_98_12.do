...
** **************************************************************************
	// GET DATA
		// Inpatient data
			use "`input_folder'/SWE_NATIONAL_PATIENT_REGISTER_1998_2012_BY_ENCOUNTERS_INPATIENT_Y2013M12D09.DTA", clear
			gen platform = "Inpatient"
			rename vtf metric_discharges
		// Outpatient data
			append using "`input_folder'/SWE_NATIONAL_PATIENT_REGISTER_2001_2012_BY_ENCOUNTERS_OUTPATIENT_Y2013M12D09.DTA"
	...
	// ENSURE ALL VARIABLES ARE PRESENT
		...
		// age (numeric)
			...
			replace age = 0.01 if age_string == "d7--27"
			replace age = 0.1 if age_string == "d28-36" | age_string == "d28-364"
...
** **************************************************************************
	...
	// SAVE
		compress
		save "`output_folder'/formatted_SWE_PATIENT_REGISTRY_98_12.dta", replace
		save "`archive_folder'/formatted_SWE_PATIENT_REGISTRY_98_12_`today'.dta", replace
