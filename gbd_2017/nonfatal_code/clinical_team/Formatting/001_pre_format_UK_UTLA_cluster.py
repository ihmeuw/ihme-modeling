...
sys.path.append(r"FILEPATH/Functions")
...
utla = pd.read_csv("FILEPATH/"
                   ...
                   r"UTLA_Y2016M10D10.CSV")

reg = pd.read_csv("FILEPATH/datasetNF03.csv")

# create icd code and year specific inpatient weights
weights = pd.read_excel("FILEPATH/NF04_DayInpatientsplit.xlsx")
...
#### testing ####
# read in population
pop = pd.read_csv("FILEPATH/uk_population.csv")
...
loc = pd.read_csv("FILEPATH/uk_location_ids.csv")
...
both.to_csv("FILEPATH/uk_utla_regional_merged_full_years_inp_only.csv",compression='gzip', index=False)
