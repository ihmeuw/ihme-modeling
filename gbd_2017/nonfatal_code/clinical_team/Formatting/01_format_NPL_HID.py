...
fpath = "FILEPATH/"\
               r"Hosp admissions three years.xlsx"
...
df15 = pd.read_excel(r"FILEPATH/"
                     r"Raw Data HMIS 2015.16.xlsx", skiprows=3)
...
df.to_hdf(r"FILEPATH/NPL_HID.H5", key="df", mode='w')
#####################################################
...
write_path = "FILEPATH/formatted_NPL_HID.H5"
