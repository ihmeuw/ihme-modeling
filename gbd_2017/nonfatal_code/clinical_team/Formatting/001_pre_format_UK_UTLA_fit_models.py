...
both = pd.read_csv("FILEPATH/"
                   r"uk_utla_regional_merged_full_years_inp_only.csv", compression='gzip')
...
both[['location_id', 'location_parent_id', 'age_start', 'age_end', 'sex_id',
      ...
      to_csv("FILEPATH/"
             r"utla_desuppressed_shiny_full_years_inp_only.csv", index=False)

both[['location_id', 'location_parent_id', 'age_start', 'age_end', 'sex_id',
      'fiscal_year', 'cause_code', 'utla_log_rate', 'value', 'preds',
      'reg_value', 'reg_resid_value', 'weight']].\
      to_csv("FILEPATH/"
             r"utla_desuppressed.csv",
             index=False)
