...
prep_path = "FILEPATH/Functions"
sys.path.append(prep_path)

import hosp_prep


input_folder = ("FILEPATH/Inpatient 3200")
...
# Below are a few functions that prep differnt years of data.  If this was for
# r"/FILEPATH/j"work, it could be split out into more functions because there are common
# chunks of code in all three.
...
def prep_2000_2011():
    ...
    column_dict = dict(zip(input_columns, template_columns))
...
def prep_2014():
    ...
    keep = ['Sex', 'Age (years)', 'Main Diagnosis (ICD10)',
            'External causes (ICD10)', 'Disharge status',  # typo: Discharge
...
write_path = "FILEPATH/formatted_GEO_COL.H5"
