...
#####################################################
df_2012 = pd.read_stata(r"FILEPATH/"
                        r"ECU_HOSPITAL_DISCHARGES_2012_Y2013M10D22.DTA",
                        columns=['Cau_cie10',  'Con_egrpa', 'Cond_edad',
                                 'Edad_pac',  'Sexo_pac'])
df_2012['year'] = 2012
df_2012.columns = map(str.lower, df_2012.columns)

df_2013 = pd.read_stata(r"FILEPATH/"
                        r"ECU_HOSPITAL_DISCHARGES_2013_Y2014M12D22.DTA",
                        columns=['cau_cie10', 'con_egrpa', 'cod_edad',
                                 'edad', 'sexo'])
df_2013['year'] = 2013

df_2014 = pd.read_stata(r"FILEPATH/"
                        r"ECU_HOSPITAL_DISCHARGES_2014_Y2016M02D02.DTA",
                        columns=['cau_cie10', 'con_egrpa', 'cod_edad',
                                 'edad', 'sexo'])
df_2014['year'] = 2014
...
# Saving the file
write_path = "FILEPATH"
df.to_hdf(write_path + r"formatted_ECU_INES_12_14.H5", key='df',
