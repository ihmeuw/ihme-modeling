...
freq_dir <- paste0(j_root, FILEPATH)
bundle <- 2957
...
freq_results <- as.data.table(fread(paste0(freq_dir, "results", gsub("-", "_", last_date), ".csv")))
...
write.xlsx(final, paste0(results_dir, "metaresults_", date, ".xlsx"))
