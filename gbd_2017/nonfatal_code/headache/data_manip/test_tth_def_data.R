...
### Author: 
### Date: 12/12/17
### Purpose: Crosswalk Definite TTH Data
### Project: GBD 2017 Nonfatal Estimation
###########################################################
...
## GET DATA
both <- get_epi_data(bundle_id = map[bundle_name == "tth_adj", bundle_id])
def <- get_epi_data(bundle_id = map[bundle_name == "def_tth_adj", bundle_id])
...
bundle_id <- map[bundle_name == "tth_adj", bundle_id]
