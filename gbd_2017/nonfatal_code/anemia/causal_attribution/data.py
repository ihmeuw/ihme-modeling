...
draw_cols = ['draw_{}'.format(d) for d in range(1000)]
...
class Data(object):
    ...
    def __init__(self, location_id, year_id, sex_id, age_group_id, draw_num, data_dir, h5_dir):
        ...
        self.env_mes = {"hgb": 10487, "prev_anemic": 10507, "prev_severe": 10491, "prev_moderate": 10490, "prev_mild": 10489}
        self.hgb_file = self.h5_dir +'hgb_d.h5'
        self.pan_file = self.h5_dir+'prev_anemic.h5'
        self.pmi_file = self.h5_dir+'prev_mild.h5'
        self.pmo_file = self.h5_dir+'prev_moderate.h5'
        self.pse_file = self.h5_dir+ 'prev_severe.h5'
    ...
    def format_to_column_orientation(self):
        ...
        assert self.prevalence.shape == (1000, 41), (
            'Prevalence draws are the wrong shape. Should be 1000 x 33')
        return self.prevalence
