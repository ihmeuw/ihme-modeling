...
The upload_eurocat.py file repreps EUROCAT data for each "total" modelable entity, removes correction factors applied to 
Turner and Klinefelter data in GBD2016, and splits EUROCAT data for Turner and Klinefelter into sex-specific sample
sizes based on updated population numbers. norway_backfill.py splits country-level EUROCAT data for Norway into 
population-weighted subnational case numbers and case sizes.
