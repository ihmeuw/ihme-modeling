...
Dependencies:  IHME
----------------------------------------------------------------------
Creation Date:    28 Jul 2017 - 15:04:52
...
*--------------------2.1: Import OCP Draws
	...
	insheet using "`in_dir'/gbd2016 rerun/GBD 2013 onchocerciasis OCP draws.csv", clear double
	tempfile gbd_2013_ocp
	save `gbd_2013_ocp', replace

*--------------------2.2: Import APOC Draws

	insheet using "`in_dir'/gbd2016 rerun/GBD 2013 onchocerciasis APOC draws.csv", clear
...
*--------------------3.2:tab out Rename/format variables
...
/*
				foreach outcome in `outcomes'{
				quietly{
					use "`local_tmp_dir'/reshaped_`set'_`outcome'.dta", clear
