################################
##purpose:Function to get most recent file in a folder
##notes:  
##arguments:    -folder: folder in which to look for files
...
require(data.table)
  ...
  files<-files[!grepl("\\~\\$", files)] ## drops any temp open files; this may break the stuffs
