...
get_life_table, with_shock(1) with_hiv(1) location_id(`location_id') life_table_parameter_id(1) gbd_round_id(5) clear
...
keep if year_id == 1990 | year_id == 1995 | year_id == 2000 | year_id == 2005 | year_id == 2010 | year_id == 2017
