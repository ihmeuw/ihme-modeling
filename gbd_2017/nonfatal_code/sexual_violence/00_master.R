...
demographics <- list(dems$sex_id, dems$location_id, dems$year_id)
...
if(prev) job.array.master(tester = test, paramlist = demographics, jobname = "prevalence", project = "proj_injuries",
