...
*** SET ENVIRONMENTAL LOCALS (PATHS, FILENAMES MODEL NUBMERS, ETC) ***
	...
	get_draws, gbd_id_field(modelable_entity_id) gbd_id(1450) location_ids(`locations') sex_ids(2) measure_ids(5) source(ADDRESS) model_version_id(`model') clear
