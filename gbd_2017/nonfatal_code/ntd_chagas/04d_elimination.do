...
* CREATE CONNECTION STRING TO "ADDRESS" DATABASE *
...
\******************************************************************************/
    ...
    * PULL IN DRAWS FROM DISMOD MODELS FOR INCIDENCE AND PREVALENVCE *
      get_draws, gbd_id_type(modelable_entity_id) gbd_id(`meid_master') source(ADDRESS) location_id(`location') age_group_id(`ages') measure_id(5 6 9) status(best) clear
