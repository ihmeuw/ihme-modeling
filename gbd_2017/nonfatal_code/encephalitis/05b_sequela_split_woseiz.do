...
// Author:		
// Last updated:	10:30 AM 7/3/2014
...
// WRITE CODE HERE
	...
	foreach location of local locations {
		...
		! qsub -P proj_custom_models -o "FILEPATH" -e "FILEPATH" -N "`job_name'" -pe multi_slot `slots' -l mem_free=`mem' "`shell_file'" "`code_dir'/`step_num'_parallel.do" ///
