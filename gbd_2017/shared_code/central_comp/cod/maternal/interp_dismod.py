...
# Author: author
# Date: GBD 2017
# Purpose: Interpolate DisMod Values to get a full time series. Need to call the
#          central function interpolate.
###################################################################################
...
logger.info("Calling interpolate")
interp_df = interpolate(gbd_id_type='modelable_entity_id',
                        gbd_id=me_id,
                        source='epi',
