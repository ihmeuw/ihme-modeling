...
def get_cause_hierarchy_version(cause_set_id=3, gbd_round_id=5,
                                server='DATABASE'):
    """
    ...
    :param server: str
        db server to use - either 'DATABASE' or 'DATABASE'
...
# Defaults 35 and 2015 for the current version


def get_location_hierarchy_version(location_set_id=35, gbd_round_id=5,
                                   server='DATABASE'):
    """
