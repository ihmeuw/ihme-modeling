shift_rr <- function(rei_id, location_id, year_id, sex_id, gbd_round_id, n_draws) {

      # pull sbp exp and exp SD
      sbp <- get_exp(107, location_id, year_id, sex_id, gbd_round_id, n_draws)
      sbp_exp_sd <- get_exp_sd(107, location_id, year_id, sex_id, gbd_round_id, n_draws)
      ...
      prevs <- mclapply(1:nrow(sbp), calc_prevc, mc.cores = 10)
      ...
      stomach_rr <- get_rr(rei_id, location_id, year_id, sex_id, gbd_round_id, n_draws)
      rr <- rbind(rr, stomach_rr)
      # save file to disk
