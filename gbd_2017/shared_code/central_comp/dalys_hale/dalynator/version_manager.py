...
class VersionManager(object):
    ...
    def __init__(self, gbd_round_id, upload_to_test=True):
        ...
        self._eng = set_engine(self.upload_env)
    ...
    def from_file(cls, versions_file):
        ...
        vm = VersionManager(gbd_round_id, upload_to_test=upload_to_test)
