...
class ImpairmentResultComputer(object):
    ...
    @property
    def draw_cols(self):
        return self.dimensions.get_simulation_dimensions(5).data_list()

    @property
    def index_cols(self):
        return self.dimensions.get_simulation_dimensions(5).index_names
