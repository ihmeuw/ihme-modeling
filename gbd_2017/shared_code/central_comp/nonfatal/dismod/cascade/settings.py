...
CUSTOM_CONDA_PATH_FILE = os.path.expanduser("~/DISMOD_CONDA_PATH")
CUSTOM_CONDA_ENV_FILE = os.path.expanduser("~/DISMOD_CONDA_ENV")
...
def read_config_file(config_path):
    if os.path.isfile(os.path.join(config_path, "config.local")):
