...
from cod_prep.claude.count_adjustments import InjuryRedistributor
...
run count-based adjustments:
    rti adjustment
    split AP and Telengana (change from multiplying sample size by a constant
    split factor to multiplying all deaths by a constant split factor)
...
def needs_strata_collapse(source):
    ...
    return source in [
        "China_Child_1996_2012", "China_MMS_1996_2005", "China_MMS_2006_2012"
    ]
