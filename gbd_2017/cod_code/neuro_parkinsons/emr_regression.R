...
cod_model_m <- 396116
dismod_model <- 292640
locations_regression <- c(4749, 80, 102, 4636, 434, 89, 79) ## England, France, US, Wales, Austria, Scotland, Netherlands, Finland 
...
dem_ages <- dems$age_group_id[dems$age_group_id >= 9] ## only need 20 and older
...
all_draws <- all_draws[age_group_id<=16, new_age := 1] ##new age group is one for 20-59
