...
// get prevalence
	get_model_results, gbd_team(epi) model_version_id(`model_dismod') measure_id(5) year_id(2017) sex_id(1 2) age_group_id(`ages') clear
	tempfile prev
	save `prev', replace

// get deaths
	get_model_results, gbd_team(cod) gbd_id(500) sex_id(1 2) year_id(2017) age_group_id(`ages') clear
	tempfile death
	save `death', replace
...
// get age_weights
	...
	keep if gbd_round_id ==5 & age_group_weight_description =="IHME standard age weight"
	tempfile weights
