* do /home/j/WORK/04_epi/02_models/01_code/06_custom/zika/code/05b_submit_death_processing.do
...
* SETUP DIRECTORIES * 
  local inputDir /home/j/WORK/04_epi/02_models/01_code/06_custom/zika/inputs
  local codeDir /home/j/WORK/04_epi/02_models/01_code/06_custom/zika/code
  local outDir /ihme/scratch/users/stanaway/zika 
...
* LOAD ESTIMATE TEMP FILES AND PROCESS BY LOCATION * 
  ...
  foreach location of local locations {
	...
	! qsub  -P proj_custom_models -pe multi_slot 8 -N zika_`location' "/home/j/WORK/04_epi/02_models/01_code/06_custom/zika/code/05c_submit_death_processing.sh" "`location'"
	sleep 100
	}
