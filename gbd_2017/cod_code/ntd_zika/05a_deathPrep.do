* do /home/j/WORK/04_epi/02_models/01_code/06_custom/zika/code/05a_deathPrep.do
...
*** SET UP ENVIRONMENT, TEMPFILES & LOCALS ***
	...
	local inputDir `j'/WORK/04_epi/02_models/01_code/06_custom/zika/inputs 
...
*** GET FATAL OUTCOMES DATA ***
	import excel `j'/WORK/04_epi/01_database/02_data/ntd_zika/01_data/2017-jan-05-phe-ZIKV-cases_cleaned.xls, sheet("Sheet1") firstrow clear
...
*** APPLY COUNTRY RANDOM EFFECTS TO ALL CHILD SUBNATIONALS ***
	...
	save `j'/WORK/04_epi/02_models/01_code/06_custom/zika/inputs/processing/deathMaster.dta, replace
