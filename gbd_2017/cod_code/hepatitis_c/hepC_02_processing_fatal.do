// Purpose: Generate estimates of Hep C deaths as a rate by multiplying symptomatic
...
//          - Prepped CFR
// Output:  Dataset (csv) of hep C deaths (as draws)
//******************************************************************************
...
* SET UP OUTPUT DIRECTORIES *  
  ...
  *import CFR
  import delimited /FILEPATH/age_specific_CFR_all_c.csv, clear
  tempfile cfr
  save `cfr'
  clear
