...
How To Use: Pass dataset_id, data_type_id, and split number to main()
'''
...
from a_inputs.a_mortality_incidence.redistribution import (
...
def run_rdp_core(df, this_dataset, split_num):
    ...
    df = dft.age_group_id_from_cancer_age(df)
    del df['age']
    df = dft.age_group_id_to_fiveYear(df)
    ...
    redistributed_df = dft.fiveYear_to_age_group_id(redistributed_df)
    redistributed_df = dft.cancer_age_from_age_group_id(redistributed_df)
    #
...
def update_redistributed_acause(df, ds_instance, split_num):
    ...
    code_format_updates = { 
        'C0': 'C00', 'C1': 'C01', 'C2': 'C02', 'C3': 'C03', 'C4': 'C04', 
        'C4A': 'C04', 'C5': 'C05', 'C6': 'C06', 'C7': 'C07', 'C8': 'C08', 
        'C9': 'C09', 'neo_other': 'neo_other_cancer'
    }
