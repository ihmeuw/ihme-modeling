...
def supplement_national_estimates(df):
    ...
    # Subset to data used to create national projections. Do not include Hong Kong
    #   in estimates for China because it throws off the trends
...
def load_ihme_pop(location_list):
    ''' loads and formats the ihme population estimate for cod mortality e
            stimation
    '''
