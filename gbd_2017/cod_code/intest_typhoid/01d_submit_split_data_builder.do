...
* BRING IN INCOME DATA *  
  odbc load, exec("SELECT location_id AS country_id, location_metadata_value AS income FROM location_metadata WHERE location_metadata_type_id = 12") `ADDRESS' clear
