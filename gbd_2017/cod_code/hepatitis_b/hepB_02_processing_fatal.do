// Purpose: Generate estimates of Hep B deaths as a rate by multiplying symptomatic
...
//          - Prepped CFR
// Output:  Dataset (csv) of hep B deaths (as draws)
//******************************************************************************
...
* BOILERPLATE *
  ...
  *import CFR
  import delimited /FILEPATH/age_specific_CFR_all_b.csv, clear
  tempfile cfr
  save `cfr'
  clear
...
* PULL IN DRAWS FROM DISMOD MODELS FOR INCIDENCE *
...
* PERFORM DRAW-LEVEL CALCULATIONS TO CALCULATE MRs *
  forvalues i = 0/999 {
    quietly {
