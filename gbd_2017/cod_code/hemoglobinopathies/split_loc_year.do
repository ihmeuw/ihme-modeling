    ...
    foreach me of local dismods {
        ...
        outsheet using "FILEPATH/interp_`me'.csv", comma replace
    }
        ...
        foreach cause of local cause_ids {
            foreach sex in 1 2 {
                preserve
                    ...
                    export delimited using "FILEPATH/`location_id'_`year_id'_`sex'.csv", replace
                restore
            }
        }
    }
