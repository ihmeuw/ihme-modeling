...
lm = get_location_metadata(location_set_id=35, gbd_round_id=5)

df = get_cod_data(cause_id='618', gbd_round_id=5) # grab the cod data for other hemog
...
pooled.to_stata('FILEPATH/cod_data_618.dta', write_index=False) # export to DTA file
