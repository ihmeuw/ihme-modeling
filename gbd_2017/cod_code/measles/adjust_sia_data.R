...
sia_1987_1999 <- fread(file.path(home, "FILEPATH/Standardized_measles_SIAs_1987_1999.csv"))
...
sia_2 <- read_excel(file.path(home, "FILEPATH/Summary_MR_SIA_Jan2000_Dec2018.xls"), skip=1) %>% as.data.table
setnames(sia_2, c("Country", "ISO", "Year", "Target", "Reached", "% Reached", "Age Group", "Survey results"), c("location_name", "ihme_loc_id", "year_id", "target", "reached", "prop_reached", "ages", "survey_coverage"))
