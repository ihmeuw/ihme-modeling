'''
COMPILE VITAL REGISTRATION

Purpose: Compile VR data (currently stored as multiple CSV files in a single 
  directory) into a single CSV file, then delete the temporary files
'''
# Imports (general)
import argparse
import numpy as np
