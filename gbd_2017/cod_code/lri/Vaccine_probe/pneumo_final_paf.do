...
// Get vaccine coverage estimates, these may be updated soon
	...
	local vi .8   // This value is the same for pneumo and Hib and are from different sources
...
////////////// NOTE that I am adding a different line for the Adjusted PAF estimates !!! ////////////////////
...
// Although Hib PAF exists for each age group, all those under 5yrs are the same //
	use location_id year_id age draw* using "FILEPATH/hib_paf_draws.dta", clear
	keep if age== "1"
	forval i = 1/1000 {
