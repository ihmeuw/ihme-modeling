...
# Load MAP model parameters
  ...
  load(paste("FILEPATH", if (all.women) "All women" else "Ever-married women", "/distributions - timefb.rdata", sep=""))
  setwd("FILEPATH")

# output.tfbp
  output.tfbp.varnames <- read.csv(paste("FILEPATH", if (all.women) "All women" else "Ever-married women", "/fitted_models/output.tfbp/output.tfbp.varnames.csv", sep=""),stringsAsFactors=FALSE )
  output.tfbp.fe <- read.csv(paste("FILEPATH", if (all.women) "All women" else "Ever-married women", "/fitted_models/output.tfbp/output.tfbp.fe.csv", sep=""), stringsAsFactors=FALSE)
  output.tfbp.iso_re<- read.csv(paste("FILEPATH", if (all.women) "All women" else "Ever-married women", "/fitted_models/output.tfbp/output.tfbp.iso_re.csv", sep=""), stringsAsFactors=FALSE)
  output.tfbp.reg_re <- read.csv(paste("FILEPATH", if (all.women) "All women" else "Ever-married women", "/fitted_models/output.tfbp/output.tfbp.reg_re.csv", sep=""), stringsAsFactors=FALSE)
  output.tfbp.errors <- read.csv(paste("FILEPATH", if (all.women) "All women" else "Ever-married women", "/fitted_models/output.tfbp/output.tfbp.errors.csv", sep=""), stringsAsFactors=FALSE)
