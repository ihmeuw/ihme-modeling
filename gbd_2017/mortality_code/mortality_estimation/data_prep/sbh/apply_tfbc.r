...
# Load TFBC model parameters
  ...
  output.tfbc.varnames <- read.csv(paste("FILEPATH", if (all.women) "All women" else "Ever-married women", "/fitted_models/output.tfbc/output.tfbc.varnames.csv", sep=""),stringsAsFactors=FALSE )
  output.tfbc.fe <- read.csv(paste("FILEPATH", if (all.women) "All women" else "Ever-married women", "/fitted_models/output.tfbc/output.tfbc.fe.csv", sep=""),stringsAsFactors=FALSE )
  output.tfbc.iso_re<- read.csv(paste("FILEPATH", if (all.women) "All women" else "Ever-married women", "/fitted_models/output.tfbc/output.tfbc.iso_re.csv", sep=""),stringsAsFactors=FALSE )
  output.tfbc.reg_re <- read.csv(paste("FILEPATH", if (all.women) "All women" else "Ever-married women", "/fitted_models/output.tfbc/output.tfbc.reg_re.csv", sep=""),stringsAsFactors=FALSE )
  output.tfbc.errors <- read.csv(paste("FILEPATH", if (all.women) "All women" else "Ever-married women", "/fitted_models/output.tfbc/output.tfbc.errors.csv", sep=""),stringsAsFactors=FALSE )
  
  ## output.tfbc.reftime
  output.tfbc.reftime.varnames <- read.csv(paste("FILEPATH", if (all.women) "All women" else "Ever-married women", "/fitted_models/output.tfbc.reftime/output.tfbc.reftime.varnames.csv", sep=""))
  output.tfbc.reftime.fe <- read.csv(paste("FILEPATH", if (all.women) "All women" else "Ever-married women", "/fitted_models/output.tfbc.reftime/output.tfbc.reftime.fe.csv", sep=""))
