...
## Save and make graphs
  ...
  if (graphs %in% c("both", "survey")) { 
    pdf(paste("FILEPATH", "plots of indirect methods - by survey.pdf", sep = ""), onefile = TRUE, width = 11, height = 8.5)
    print(
  ...
  if (graphs %in% c("both", "country")) { 
    pdf(paste("FILEPATH", "plots of indirect methods - by country.pdf", sep = ""), onefile = TRUE, width = 11, height = 8.5)
    print(
    xyplot(q5.pred ~ t | group, output, groups = method,
