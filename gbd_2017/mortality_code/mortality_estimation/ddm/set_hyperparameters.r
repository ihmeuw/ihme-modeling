...
# 
# Notes: 1) DDM's run_all will execute this script passing version_id and saving in "inputs" folder on /ihme/mortality/ddm/{version_id}/inputs
#        2) This script will need to modified, committed, and pulled down remotely prior to DDM run execution
...
write_csv(hyper_param, paste0(out_dir, "hyperparameters.csv"))
