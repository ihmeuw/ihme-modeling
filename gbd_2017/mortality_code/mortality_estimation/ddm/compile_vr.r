...
gbd_year <- 2017
proc_lineage <- setDT(get_proc_lineage(model_name = "ddm", model_type = "estimate", run_id = ddm_version_id))
...
main_dir <- paste0("FILEPATH", ddm_version_id)
...
vr_2017 <- copy(vr)
write_csv(vr_2017, paste0(main_dir, "/agg_vr.csv"))
rm(vr)
