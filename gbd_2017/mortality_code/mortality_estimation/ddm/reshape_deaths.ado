...
local test = 0
if `test' == 1 {
	local popdata "FILEPATH\d02_reshaped_population_ZWE.dta"
	local data "FILEPATH\d01_formatted_deaths_ZWE.dta"
	local iso3 "ZWE"
	local saveas "FILEPATH\d02_reshaped_deaths_ZWE.dta"
