...
# eliminate SRS for the India states from the VR file (we are using aggregate estimates) - 1/7/16, no longer doing this 3/18/16
data_vr = data_vr.loc[~((data_vr['ihme_loc_id'].str.match("IND_")) &
                      (data_vr['deaths_source'].isin(['SRS', 'SRS_REPORT'])))]
...
data.loc[(data['ihme_loc_id'] == "NER"), 'lambda'] = 0.4
