...
#'
#' Subtract HIV cause-specific mx, bounded by HIV proportion proportion values, from 45q15 and 5q0 to generate HIV-free 45q15 and 5q0 values
#'
...
#' @param hiv_draws data.table with variables: ihme_loc_id, year, sex, adult_hiv_cdr, child_hiv_cdr. Post-rescaling HIV CDR based on various scaling values. Now mean values rather than draw-specific.
#' @param hiv_prop_range data.table with variables: ihme_loc_id, sex, upper_adult, upper_child. Generated by Spectrum, perhaps the upper 97.5 percentile bound on HIV deaths/envelope proportion
#' @param hiv_ctry_groups data.table with variables: ihme_loc_id, sex, group (character). Used to generate a floor for HIV-free values in high-HIV countries that risk having a false floor of HIV.
#'
