** From HMD results, generate paramaeters to extend qx from age 60 through 95 up, based on relative relationships with previous age and other relationships.
clear all
set more off
...
** Drop lifetables deemed by HMD to be low quality
...
export delimited "hmd_qx_extension.csv", replace
...
export delimited "hmd_ax_extension.csv", replace
