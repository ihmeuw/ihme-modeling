...
from gbdu5.io import get_sex_data, read_empirical_life_tables
...
age_group_days = {'enn': 7, 'lnn': 21, 'pnn': 337,
                  '1': 365, '2': 365, '3': 365,
                  '4': 365}
...
for a in ['enn', 'lnn', 'pnn'] + [str(x) for x in range(1, 5)]:
...
df_births['location_id'] = location_id
...
final_data = final_data.loc[final_data['year'] <= 2017]
