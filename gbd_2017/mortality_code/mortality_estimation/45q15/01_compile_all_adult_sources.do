...
** Add in SIBS
  ...
  cap drop svy
	...
	use "02. Add adult only data/Aggregate 45q15s/IFLS/ifls_45q15s.dta", clear
	append using "02. Add adult only data/Aggregate 45q15s/SUSENAS/EST_SUSENAS_1996_v45q15.dta"
	append using "02. Add adult only data/Aggregate 45q15s/SUSENAS/EST_SUSENAS_1998_v45q15.dta"
	append using "02. Add adult only data/Aggregate 45q15s/Various/various_45q15s.dta"
	append using "02. Add adult only data/Aggregate 45q15s/VNM PCFPS/EST_PCFPS_VNM_HHDeaths_v45q15.dta"
	append using "02. Add adult only data/Aggregate 45q15s/China epi by sex/china_life_table_1973_1975_aggregate_45q15.dta"
	...
	replace ihme_loc_id = "CHN_44533" if ihme_loc_id == "CHN" & inlist(deaths_source,"FERTILITY_SURVEY","EPI_SURVEY") 
	...
	drop if ihme_loc_id=="IND_4871" & year < 2014 
...
** Source NID
	...
	replace nid = 20663 if ihme_loc_id == "VNM" & year == 2006.5 & deaths_source == "PCFPS"
...
** Mark outliers
	...
	replace exclude = 1 if ihme_loc_id == "MEX_4649" & year == 1983 & source_type == "VR" 
