...
##notes:   based off of knockout.py function from CODEM
##
##
##
#
...
prep_ko<-function(data, location_set_id=22, start_year=1980, end_year=2017, by_sex=1, by_age=1, remove_subnats=F){
  if(F){
  ...
  sqr<-make_square(l_set_v_id, start_year, end_year, covariates=NA, by_age=by_age, by_sex=by_sex)
