...
load(paste0(main_dir, "FILEPATH/high_bp_model.rdata"))
...
##sy:calculate probability of sbp>140 or dbp>90 based on charleton's imputations (the hypertensive col)  The prediction is sbp>140 or dbp>90
...
load(paste0(main_dir, "FILEPATH/high_cholesterol_model.rdata"))
...
##sy:drop individual imputations
