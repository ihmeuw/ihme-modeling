...
##notes:  -Disorganized system for testing different datasets and diagnostic criteria, sorry!!
...
##
##
##          -Next steps: -need to fix CI on graph of lm line 
##                        -
##     ##NECESSARY SCRIPT
#######################################
...
daig_path<-paste0("FILEPATH/dc_to_crosswalk.csv")
...
if(rx==T){
  if(me=="sbp"){
    ...
    ##USERNAME:  combos
    df[get(me)>=cutoff   &   dbp>=variant_cutoff  &  (sbp_rx!=1  |  is.na(sbp_rx)),   diseased:=4 ]  ##sy; sbp and dbp
  ...
  ## Create binary if condition is met in the df  ##USERNAME:  Patty's old system was more flexible, I should revert back to it eventually
