...
pops <- get_population(location_set_version_id = 397, year_id = c(1970:2017), sex_id = c(1,2), location_id = -1, 
...
vehicles_pc <- get_covariate_estimates(covariate_id=154)
...
outphase_smooth <- get_covariate_estimates(covariate_id=1154)
...
#save data
write.csv(out, paste0("FILEPATH"), row.names=F)