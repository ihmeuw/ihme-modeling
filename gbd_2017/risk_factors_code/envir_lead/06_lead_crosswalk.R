...
# model accounts for age, sdi, cv_mean_type, super region's interaction with urbanicity, and the outphasde of leaded gasoline interacted 
...
# remove group review data that is duplicate
...
write.csv(coefficients, paste0("FILEPATH"), row.names=F)
