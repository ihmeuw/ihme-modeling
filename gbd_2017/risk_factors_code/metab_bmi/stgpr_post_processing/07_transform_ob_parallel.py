...
def backtransform(loc_id, ow_run_id, ob_run_id, date):
    ow = pd.read_csv(os.path.join("FILEPATH", str(ow_run_id),
                                  "draws_temp_1/", "{}.csv".format(loc_id)))
    ob = pd.read_csv(os.path.join("FILEPATH", str(ob_run_id),
                                  "draws_temp_1/", "{}.csv".format(loc_id)))
    ...
    if not os.path.exists(os.path.join("FILEPATH", date, "child_draws_ow")):
        os.mkdir(os.path.join("FILEPATH", date, "child_draws_ow"))
    os.chdir(os.path.join("FILEPATH", date, "child_draws_ow"))
    ow[ow['age_group_id'].isin([5, 6, 7, 8])].to_csv('{}.csv'.format(loc_id))

    if not os.path.exists(os.path.join("FILEPATH", date, "expanded_adult_draws_ow")):
        os.mkdir(os.path.join("FILEPATH", date, "expanded_adult_draws_ow"))
    os.chdir(os.path.join("FILEPATH", date, "expanded_adult_draws_ow"))
    ow[~ow['age_group_id'].isin([5, 6, 7, 8])].to_csv('{}.csv'.format(loc_id))
    ...
    if not os.path.exists(os.path.join("FILEPATH", date, "child_draws")):
        os.mkdir(os.path.join("FILEPATH", date, "child_draws"))
    os.chdir(os.path.join("FILEPATH", date, "child_draws"))
    ...
    if not os.path.exists(os.path.join("FILEPATH", date, "draws_transformed_adult")):
        os.mkdir(os.path.join("FILEPATH", date, "draws_transformed_adult"))
    os.chdir(os.path.join("FILEPATH", date, "draws_transformed_adult"))
    specific[~specific['age_group_id'].isin([5, 6, 7, 8])].to_csv('{}.csv'.format(loc_id))
    ...
    if not os.path.exists(os.path.join("FILEPATH", date, "child_ow_not_ob")):
        os.mkdir(os.path.join("FILEPATH", date, "child_ow_not_ob"))
    os.chdir(os.path.join("FILEPATH", date, "child_ow_not_ob"))
