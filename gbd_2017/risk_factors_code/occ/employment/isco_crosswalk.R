...
write.csv(collapse, file.path(out.dir, "ISCO_08_TO_ISCO_88_LVL_1_CW.csv"),row.names=F)
...
write.csv(collapse, file.path(out.dir, "ISCO_68_TO_ISCO_88_LVL_1_CW.csv"),row.names=F)
