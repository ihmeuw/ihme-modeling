# ---HEADER-------------------------------------------------------------------------------------------------------------
# Purpose: Calculate occupational carcinogen exposure
#***********************************************************************************************************************
...
# load packages
# pacman::p_load(data.table, fst, gridExtra, ggplot2, lme4, magrittr, parallel, stringr, readxl, zoo, readxl)
pacman::p_load(data.table, gridExtra, ggplot2, lme4, magrittr, parallel, stringr, zoo, readxl)
library(fst, lib.loc = file.path(h_root))
...
gbd.years <- c(seq(1990,2005,5),2007,2010,2015,2016,2017)
