...
# load packages
# pacman::p_load(data.table, DBI, gridExtra, ggplot2, lme4, magrittr, parallel, stringr, readxl, zoo)
...
covs <- get_covariate_estimates(881)[,list(location_id,year_id,mean_value)]
