...
** prep under-5 population from the standard mortality group population file
	...
	** create Andhra PrUSER Old under 5 pops
	...
	insheet using "FILEPATH/prediction_model_results_all_stages.txt", clear
...
** for countries with 1 data point (only PRK as of now) duplicate the point 25% above and below to create plausible confidence intervals similar to 45q15
...
**************************************************************************************************
	...
	** get codebook to go from province number to fake iso3 
...
** save final prepped file for GPR process
	outsheet super_region_name region_name ihme_loc_id year ldi_id maternal_educ hiv data category vr mort mort2 logit_mort mse pred1b resid pred2resid pred2final ptid source1 reference log10sdq5 biasvar logit_var using "FILEPATH/gpr_5q0_input.txt", comma replace

	** save an archived version for reference
	outsheet super_region_name region_name ihme_loc_id year ldi_id maternal_educ hiv data category vr mort mort2 logit_mort mse pred1b resid pred2resid pred2final ptid source1 reference log10sdq5 biasvar logit_var using "FILEPATH/gpr_5q0_input_`c(current_date)'.txt", comma replace 
