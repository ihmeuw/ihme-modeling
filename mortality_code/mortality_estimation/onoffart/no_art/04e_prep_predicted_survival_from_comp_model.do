...
foreach a of local ages {
	...
	insheet using "`comp_dir'/output/`a'_sample_survival_predictions.csv", clear comma names
	...
	insheet using "`comp_dir'/output/`a'_sample_mortality.csv", clear comma names
	generate draw = _n
...
**************************************************************
save "`comp_dir'/output/surv_draws.dta", replace
...
**************************************************************
outsheet using "`comp_dir'/output/survival_curve_preds.csv", replace comma names
...
preserve
	...
	outsheet using "`comp_dir'/output/survival_uncertainty.csv", replace comma names
restore
...
preserve
	...
	outsheet using "`comp_dir'/output/median_survival.csv", replace comma names
