...
# Seed infections into CD4 categories based off of 1000 infections.  This uses UNAIDS dUSERts.
s1 <- c(643, 607, 585, 552)
s2 <- c(357, 393, 415, 448)

s.tot <-s1 + s2

# f.1 vectors - one for each age group.  F.1 is the rate at which infected individuals progress through the first CD4 category (CD4 > 500).
f.1 <- rep(0, 4)
f.1[1] <- 0.117
f.1[2] <- 0.15
f.1[3] <- 0.183
