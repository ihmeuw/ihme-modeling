...
if c(os)=="Unix" {
	...
	local codefolder	"$j/Project/Causes of Death/CoDMod/Models/B/codes/dismod_ode"
...
//	sleep 2000
	...
	//! /home/j/temp/ctroeger/LRI/dismod/model_draw.py.in	draw_in.csv value_tmp.csv plain_tmp.csv rate_tmp.csv effect_tmp.csv sample_out.csv draw_out.csv
