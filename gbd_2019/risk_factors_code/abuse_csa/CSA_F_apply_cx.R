...
bid<-416
bvid<-15692
acause<-"abuse_csa_female"
mrbrtname1 <- "csa_Female_int_contact_perp"
mrbrtname2 <- "csa_female_recall_u15"
ds<-"step4"
gbd_rnd<-6
...
remove_cols<-remove_cols[remove_cols%in%names(xwalk_dt)]vd
...
save_crosswalk_version(bvid, data_filepath = paste0(output_file_name),
                       description =  "crosswalked new data for step4")
