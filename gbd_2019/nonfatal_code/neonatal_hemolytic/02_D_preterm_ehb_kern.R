...
preterm <- fread(file = 'FILEPATH/preterm_aggregate_birth_prevalence.csv')
...
prev_long <- merge(preterm_long, kern_long, by = c('location_id','year','draw.id'), suffixes = c('.ehb','.kern'), all.x = TRUE)
...
write.csv(ehb_prev_wide, file = 'FILEPATH/preterm_ehb_all_draws.csv',
          row.names = FALSE)
...
write.csv(kern_prev_wide, file = 'FILEPATH/preterm_kernicterus_all_draws.csv',
          row.names = FALSE)
...
write.csv(ehb_prev_wide, file = 'FILEPATH/preterm_ehb_summary_stats.csv',
          row.names = FALSE)
...
write.csv(kern_prev_wide, file = 'FILEPATH/preterm_kernicterus_summary_stats.csv',
          row.names = FALSE)
