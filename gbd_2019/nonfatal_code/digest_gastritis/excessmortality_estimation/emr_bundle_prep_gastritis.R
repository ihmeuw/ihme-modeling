...
bundle_version <- 2498 #bundle version associated with step2 best crosswalk version
extractor <- USER_ID #UW name
path_upload <- 'FILEPATH/2019_step3_bundle_vers_for_emr_upload.xlsx' #upload location for your cause
bundle_id <- 7001 #new bundle ID provided by central comp for EMR method change
...
# 12221 - new bundle version gastritis
...
# 60180 - seq for EMR dummy row gastritis