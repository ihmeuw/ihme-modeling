...
uses_csmr <- F
test_sex_by_super_region <- F # tested high-income vs rest, not significant.
crosswalk_pairs <- 'FILEPATH.csv'
new_data_filename <- "FILEPATH.xlsx"
new_age_sex_split_estimates <- "FILEPATH.xlsx"
decomp_2_bundle_version <- 7118
need_save_bundle_version <- 14207
sex_ratio_by_age <- T
...
save_crosswalk_version(v_id, 'FILEPATH.xlsx', description = "Decomp 4 new data")
