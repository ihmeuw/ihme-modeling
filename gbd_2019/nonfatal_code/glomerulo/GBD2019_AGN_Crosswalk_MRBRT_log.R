...
## NOTE: LITERATURE DATA WERE EXCLUDED BECAUSE WE COULDN'T MATCHES
...
cause_path <- "glomerulo"  #SPECIFY FILEPATH
cause_name <- "glomerulo" #SPECIFY CAUSE NAME


#CREATE COVARIATES AND TAG REFERENCE vs. ALTERNATIVE
df <- as.data.table(read.csv("FILEPATH FOR ADMIN DATA"))
