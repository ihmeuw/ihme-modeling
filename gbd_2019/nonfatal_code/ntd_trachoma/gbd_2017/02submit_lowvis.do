...
* SAVE RESULTS * 
  run FILEPATH
  save_results_epi, modelable_entity_id(ADDRESS) measure_id(ADDRESS) description("Proportion of low vision due to trachoma (custom mixed effects)-no restrict") input_dir("FILEPATH") input_file_pattern({location_id}.csv) clear 
