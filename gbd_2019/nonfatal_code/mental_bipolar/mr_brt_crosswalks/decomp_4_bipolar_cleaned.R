#######################################################################################
### Purpose:  Estimate Sex-ratio and crosswalks for GBD2019 decomp 4
#######################################################################################
...
### Specifiy important components of the code
...
decomp_2_bundle_version <- 8381
need_save_bundle_version <- 15239
sex_ratio_by_age <- F
...
review_sheet_final[study_covariate == "sex", `:=` (cases = NA, sample_size = NA)]
...
review_sheet_final[is.na(standard_error), standard_error := NA]
...
save_crosswalk_version(v_id, crosswalk_save_file, description = "Decomp 4 new data")
