...
master_mrbrt_crosswalk <- function(
  ...
  if (!sex_split_only) {
    ...
    if(logit_transform) {
      ...
      ## However, if mean is 0, we need to adjust the uncertainty in normal space, not log-space, from this conversation: "LINK"
  ...
  if (write) {
    ...
    # adjust data to pass epiDataUploader test
