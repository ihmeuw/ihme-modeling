...
# save.image(file=paste0("FILEPATH/mi_114_image.Rdata"))
# message("\n[INFO] mi_114_image before master_mrbrt_crosswalk saved to ", paste0("FILEPATH/mi_114_image.Rdata"), "\n")
...
if(save_rdata_local) {
  save(crosswalk_holder, var_collector, file = paste0("FILEPATH/", model_abbr , ".Rdata"))
  message(paste0("\n [INFO] All results saved to ", "FILEPATH/", model_abbr , ".Rdata\n"))
}
...
rmarkdown::render(
  ...
  output_file = paste0("FILEPATH/", model_abbr, "_", date, ".html"),
  clean = TRUE,
