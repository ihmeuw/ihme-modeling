...
for (me in c("aort", "mitral")) {
  ...
  data[location_id %in% c(4622,4624,95), `:=` (location_id=4749, location_name="England", ihme_loc_id="GBR_4749", step2_location_year="UTLA data points reextracted as 'England' because of the location heirarchy. -sophiameb")]
