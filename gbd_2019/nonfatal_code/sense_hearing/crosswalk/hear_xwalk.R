...
###### Author: USER
###### Date: 3/27/2019
###### Purpose: To prepare the hearing crosswalk data for input to mrBRT. This code will...
...
##############################################
####### Step 3: Transform SE to log space ####
##############################################
# ratios$delta_log_se <- sapply(1:nrow(ratios), function(i) {
#   ratio_i <- ratios[i, "xwalk"]
#   ratio_se_i <- ratios[i, "xwalk_se"]
