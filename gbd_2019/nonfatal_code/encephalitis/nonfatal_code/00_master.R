...
# Define the steps to run as space-separated list: "02a 02b 03a 03b 04a // 04b 05a 05b 09"
# steps <- c("04b", "05a", "05b", "09")
...
# Specify location
# type "all" for all locations
# or specify one or more test locations
loc <- "all"
...
enceph_dir # filepath
dir.create(enceph_dir, showWarnings = F)
...
model_custom(code_dir, out_dir, tmp_dir, date, steps, in_dir, ds, new_cluster)
