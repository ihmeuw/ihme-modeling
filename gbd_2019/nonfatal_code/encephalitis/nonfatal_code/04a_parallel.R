...
get_epilespy_estimates <- function(gbd_id = 2403, my_id, my_name) {
  draws <- get_draws(gbd_id_type = "modelable_entity_id", gbd_id = 2403, measure_id = my_id, age_group_id = ages, source = "epi", location_id = location, gbd_round_id = 6, decomp_step = ds)
  setDT(draws)
