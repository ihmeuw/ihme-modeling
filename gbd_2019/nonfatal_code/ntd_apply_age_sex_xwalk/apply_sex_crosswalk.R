...
apply_sex_crosswalk <- function(mr_brt_fit_obj, all_data, decomp_step){
  ...
  cat("\nStarting sex crosswalk. Populations are aggregated by single-year ages.\n")
  ...
  cat("\n\nInput data of 0 prevalence is split into male and female rows with 0's and the points orginal standard error\n")
