...
crosswalk_pairs <- '' # no crosswalks for conduct
new_data_filename <- "FILEPATH.xlsx"
new_age_sex_split_estimates <- "FILEPATH.xlsx"
decomp_2_bundle_version <- 6761
need_save_bundle_version <- 14822
sex_ratio_by_age <- F
...
review_sheet_final[study_covariate != "ref" & measure != "mtstandard", `:=` (lower = NA, upper = NA, cases = NA, sample_size = NA)]
...
save_crosswalk_version(v_id, crosswalk_save_file, description = "Decomp 4 new data - remove adult data #2")
