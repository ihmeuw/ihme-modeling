...
Import data
'''
input_file = "{}/gpr_input_file_{}_{}.csv".format(input_dir, sex, age)
...
'''
model_parameter_file = "{}/{}_{}_model_params.txt".format(input_dir, sex, age)
...
output_file = "{}/gpr_{}_{}_{}_sim.txt".format(output_dir, cc, sex, age)
