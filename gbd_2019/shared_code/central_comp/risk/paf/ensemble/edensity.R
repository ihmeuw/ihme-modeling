...
Rcpp::sourceCpp("./ensemble/scale_density_simpson.cpp")
...
#   scale=TRUE rescales the density so that it integrates to 1 across the defined
#     X vector if the probability is constrained as such

get_edensity <- function(weights, mean, sd, .min, .max, scale = TRUE) {
