...
import dalynator.run_pipeline_dalynator as pipeline
...
try:
    ...
    logger.info("Arguments passed to remote_run_pipeline_dalynator: {}".format(args))
    ...
    message = "remote_run_pipeline_dalynator {l}, {y} failed with an uncaught exception: {ex}" \
