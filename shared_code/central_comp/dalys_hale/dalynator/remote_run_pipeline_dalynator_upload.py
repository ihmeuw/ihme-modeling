...
import dalynator.run_pipeline_dalynator_upload as pipeline
...
try:
    ...
    logger.info(
        "Arguments passed to run_pipeline_dalynator_upload {}".format(args))

    pipeline.run_dalynator_upload(args.out_dir, args.gbd_process_version_id,
    ...
    message = "remote_run_pipeline_dalynator_upload {m} failed with an uncaught exception: {ex}; locations: {ls}" \
