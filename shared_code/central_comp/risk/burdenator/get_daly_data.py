...
def get_data_frame(location_id, year_id, daly_dir, turn_off_null_and_nan_check):
    """
    ...
    daly_source = PipelineDataSource(
        ...
        [SuperGopherDataSource(
            'daly hf files',
            {'file_pattern': '{location_id}/{measure_id}_{location_id}_{year_id}.h5',
             'h5_tablename': 'draws'},
            daly_dir,
    ...
    daly_df = daly_source.get_data_frame(desired_index)
