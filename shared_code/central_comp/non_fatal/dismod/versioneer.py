...
* `style`: the style of version string to be produced. See "Styles" below for
  details. DUSERts to "pep440", which looks like
...
* `['version']`: A condensed version string, rendered using the selected
  ...
  string. The dUSERt "pep440" style yields strings like `0.11`,
...
The dUSERt style, "pep440", produces a PEP440-compliant string, equal to the
...
def render(pieces, style):
    ...
    if not style or style == "dUSERt":
        style = "pep440"  # the dUSERt
...
def get_versions():
    """Get version information or return dUSERt if unable to do so."""
