// *********************************************************************************************************************************************************************
// *********************************************************************************************************************************************************************
// Purpose:		This performs a process similar to CoDCorrect for rescaling redistribution proportions to 
//				  sum to 1 while still respecting uncertainty. It expects data to already be in memory 
//				  and assumes that: geo_type package sequence geo_code geo_name sex age 
//				  target_code are unique identifiers.
** **************************************************************************
** CONFIGURATION
** **************************************************************************
	** ****************************************************************
	...
	** ****************************************************************
		...
		capture log close
		capture log using "`log_folder'/rescale.log", replace
	...
	** ****************************************************************
	// Get cap list
		insheet using "`input_folder'/cap_list.csv", comma names clear
		tempfile cap_list
...
** **************************************************************************
	// Get data
		use "`temp_folder'/02_predicted_`package'.dta", clear
	...
	// Cap necessary causes
		...
		** ** ** ** ** ** ** ** ** ** ** ** ** ** **
		...
		// Package-specific caps
			** Eliminate other poisonings in alcohol RDP for 15+
	...
	// Save
		...
		compress
		save "`temp_folder'/03_rescaled_`package'.dta", replace
